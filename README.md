...
* [FLIP Fluids](https://github.com/rlguy/Blender-FLIP-Fluids) ⭐ 1,935 | 🐛 5 | 🌐 C++ | 📅 2026-07-27 : is a powerful liquid simulation plugin that gives you the ability to create high quality fluid effects all within Blender, the free and open source 3D creation suite. [![market]](https://blendermarket.com/products/flipfluids)
...
* [Jet-Fluids](https://github.com/PavelBlend/blender_jet_fluids_addon) ⭐ 103 | 🐛 9 | 🌐 Python | 📅 2023-12-09 : [Jet fluid](https://github.com/doyubkim/fluid-engine-dev) ⭐ 2,098 | 🐛 60 | 🌐 C++ | 📅 2023-12-24 simulator integration in blender.

### 🦑Generator/Builder [^](#table)

* [Spaceship Generator](https://github.com/a1studmuffin/SpaceshipGenerator) ⭐ 7,815 | 🐛 29 | 🌐 Python | 📅 2024-05-25 : procedurally generate 3D spaceships.
* [CharMorph](https://blenderartists.org/t/charmorph-character-creation-tool-mb-lab-based/1252543) : An open source character creation tool for Blender. It's a rewrite of [MB-Lab](https://github.com/animate1978/MB-Lab) ⚠️ Archived, which is now unmaintained. [![][repo]](https://github.com/Upliner/CharMorph) ⭐ 561 | 🐛 30 | 🌐 Python | 📅 2025-05-29
...
* [MPFB](http://static.makehumancommunity.org/mpfb.html) : MPFB2 is an open source human generator for Blender. It's complete rewrite of MakeHuman as a Blender addon. [![][repo]](https://github.com/makehumancommunity/mpfb2) ⭐ 571 | 🐛 76 | 🌐 Python | 📅 2026-08-10
...
* Environment:
  * [Infinigen](https://infinigen.org) : Infinigen is a procedural generator of 3D scenes. It can generate infinite Photorealistic Worlds using real geometry. Infinigen is optimized for computer vision research and generates diverse high-quality 3D training data. [![][repo]](https://github.com/princeton-vl/infinigen) ⭐ 7,205 | 🐛 197 | 🌐 Python | 📅 2026-08-05
...
* [fspy](https://fspy.io/) : is an open-source camera matching app, extremely useful for modeling directly from a reference image. [(blender addon)](https://github.com/stuffmatic/fSpy-Blender) ⭐ 1,439 | 🐛 59 | 🌐 Python | 📅 2022-05-04
* [BezierUtility](https://github.com/Shriinivas/blenderbezierutils) ⭐ 627 | 🐛 17 | 🌐 Python | 📅 2026-06-17 : This add-on contains several tools for working with Bezier curves.
* [JewelCraft](https://github.com/mrachinskiy/jewelcraft) ⭐ 584 | 🐛 0 | 🌐 Python | 📅 2026-08-16 : jewelry design toolkit add-on for Blender.
...
* CAD:
  * [CAD Sketcher](https://www.cadsketcher.com) : CAD Sketcher is a free and open-source project looking to enhance precision workflows in blender by bringing CAD like tools, features and usability. [![][repo]](https://github.com/hlorus/CAD_Sketcher) ⭐ 3,387 | 🐛 29 | 🌐 Python | 📅 2026-08-14 ![][gpl]
  * [BlenderBIM](https://blenderbim.org) : An add-on for beautiful, detailed, and data-rich OpenBIM with Blender. [![][repo]](https://github.com/ifcopenshell/ifcopenshell) ⭐ 2,708 | 🐛 1,943 | 🌐 C++ | 📅 2026-08-17 ![][gpl]
  * [Sverchok](https://nortikin.github.io/sverchok) : is a powerful parametric tool for architects, allowing geometry to be programmed visually with nodes. [![][repo]](https://github.com/nortikin/sverchok) ⭐ 2,512 | 🐛 220 | 🌐 Python | 📅 2026-08-02 ![][gpl]
...
* Retopology/Remesh:
  * [retopoflow](https://blendermarket.com/products/retopoflow) : A suite of retopology tools for Blender. [![][repo]](https://github.com/CGCookie/retopoflow) ⭐ 3,188 | 🐛 92 | 🌐 Python | 📅 2026-07-25
...
* Sculpt:
  * [GoB](https://github.com/JoseConseco/GoB) ⭐ 754 | 🐛 75 | 🌐 Python | 📅 2026-06-25 : GoZ-alike tools for simple ZBrush-Blender interchange.
...
* [COA Tools](https://github.com/ndee85/coa_tools) ⭐ 973 | 🐛 117 | 🌐 Python | 📅 2024-05-02 : is a 2D Animation Suite for blender. It offers a 2D cutout animation workflow similar to programs like spine or spriter.
...
* Rigging:
  * [Wiggle Bones](https://blenderartists.org/t/wiggle-2/1454788) : Jiggle bone implementation for Blender with realistic physics. [![][repo]](https://github.com/shteeve3d/blender-wiggle-2) ⭐ 1,013 | 🐛 71 | 🌐 Python | 📅 2024-04-18 ![][gpl]
  ...
  * [BlenRig](https://www.blendermarket.com/products/blenrig) : BlenRig is an Auto-rigging and skinning system. It provides the user with a Feature Film quality rig; including an advanced facial system. [![][repo]](https://github.com/jpbouza/BlenRig) ⭐ 164 | 🐛 8 | 🌐 Python | 📅 2025-04-16 ![][gpl]
  * [Rigid Body Bones](https://github.com/Pauan/blender-rigid-body-bones) ⭐ 154 | 🐛 13 | 🌐 Python | 📅 2023-05-03 : Blender addon which adds rigid body / spring physics to bones.
...
* [DreamWork's MoonRay](https://openmoonray.org/) : MoonRay is a physically based path-tracing renderer; it includes a USD Hydra render delegate, multi-machine and cloud rendering via the Arras distributed computation framework. [![][repo]](https://github.com/dreamworksanimation/openmoonray) ⭐ 4,716 | 🐛 74 | 🌐 CMake | 📅 2026-08-15
* [Mitsuba Renderer](https://www.mitsuba-renderer.org/) : Mitsuba 3 is a research-oriented retargetable rendering system for forward and inverse light transport simulation. [![][repo]](https://github.com/mitsuba-renderer/mitsuba3) ⭐ 2,888 | 🐛 130 | 🌐 C++ | 📅 2026-08-13 [(blender addon)](https://github.com/mitsuba-renderer/mitsuba-blender) ⭐ 363 | 🐛 34 | 🌐 Python | 📅 2026-07-13
...
* [LuxCore](https://luxcorerender.org/) : LuxCoreRender is a physically based and unbiased rendering engine. It offers advanced features like accelerated rendering of indirect light and efficient rendering of caustics. [![][repo]](https://github.com/LuxCoreRender/LuxCore) ⭐ 1,318 | 🐛 104 | 🌐 C++ | 📅 2026-08-05 [(blender addon)](https://github.com/LuxCoreRender/BlendLuxCore) ⭐ 867 | 🐛 124 | 🌐 Python | 📅 2026-08-08 ![][gpl]
* [Malt](https://malt3d.com/) : Malt is a non photorealistic rendering (NPR) framework. It offers fully customizable real-time rendering framework for animation and illustration. [![][repo]](https://github.com/bnpr/Malt) ⭐ 1,122 | 🐛 27 | 🌐 Python | 📅 2026-03-29 ![][mit]
...
* [TexTools](https://blenderartists.org/t/textools-for-blender/700811) : TexTools is a Free addon for Blender 3D with a set of professional UV and Texturing tools. [![][repo]](https://github.com/SavMartin/TexTools-Blender) ⭐ 2,372 | 🐛 53 | 🌐 Python | 📅 2024-12-02
* [UcuPaint](https://github.com/ucupumar/ucupaint) ⭐ 2,219 | 🐛 104 | 🌐 Python | 📅 2026-08-16 : A addon to manage texture layers for EEVEE and Cycles renderer.
* [DreamUV](https://github.com/leukbaars/DreamUV) ⭐ 1,781 | 🐛 46 | 🌐 Python | 📅 2026-04-17 : is a collection of tools that allow you to manipulate UVs in the 3D viewport.
...
* [Lily Surface Scrapper](https://github.com/eliemichel/LilySurfaceScrapper) ⭐ 624 | 🐛 70 | 🌐 Cython | 📅 2026-06-19 : Import shaders in Blender from a single URL.
...
* [Blender For Unreal Engine](https://github.com/xavier150/Blender-For-UnrealEngine-Addons) ⭐ 2,634 | 🐛 9 | 🌐 Python | 📅 2026-08-10 : This Add-on allows you to export content created with Blender to Unreal Engine 4.
...
* Game Engine:
  * [Armory3D](https://armory3d.org/) : is an open-source 3D game engine with full Blender integration. [![][repo]](https://github.com/armory3d/armory) ⭐ 3,316 | 🐛 394 | 🌐 C++ | 📅 2026-07-16
  * [UPBGE](https://upbge.org/) : is an open-source 3D game engine forked from old Blender Game Engine, deployed with Blender itself. [![][repo]](https://github.com/UPBGE/upbge) ⭐ 1,795 | 🐛 134 | 🌐 C++ | 📅 2026-08-17
...
* [Set Viewport Color](https://github.com/eliemichel/LilySurfaceScrapper) ⭐ 624 | 🐛 70 | 🌐 Cython | 📅 2026-06-19 : Blender Script to Set the Viewport Color based on a nodetree.
...
* [NodeToPython](https://github.com/BrendanParmer/NodeToPython) ⭐ 359 | 🐛 21 | 🌐 Python | 📅 2026-07-11 : Convert Geometry, Shader, and Compositing nodes to legible Python scripts and add-ons. [![][mit]](https://github.com/BrendanParmer/NodeToPython/blob/main/LICENSE) ⭐ 359 | 🐛 21 | 🌐 Python | 📅 2026-07-11
...
* Geographic/Maps:
  * [BlenderGIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,298 | 🐛 319 | 🌐 Python | 📅 2025-12-20 : Blender addons to make the bridge between Blender and geographic data.
...
* Display:
  * [Screencast-Keys](https://github.com/nutti/Screencast-Keys) ⭐ 1,427 | 🐛 2 | 🌐 Python | 📅 2026-05-23 : Status Add-On for Blender.
...
* VideoEditor:
  ...
  * [Push to Talk](https://github.com/britalmeida/blender_addon_push_to_talk) ⭐ 78 | 🐛 3 | 🌐 Python | 📅 2025-10-30 : Convenient recording of scratch dialog for an edit.
...
* [Awesome-3D-Meshes : List of famous 3D meshes.](https://github.com/jvm-graphics-labs/awesome-3d-meshes/) ⭐ 120 | 🐛 0 | 📅 2019-04-25
...
* [NASA-3D-Resources](https://nasa3d.arc.nasa.gov/) : Here you'll find a growing collection of 3D models, textures, and images from inside NASA. All of these resources are free to download and use. [![][repo]](https://github.com/nasa/NASA-3D-Resources) ⭐ 3,744 | 🐛 5 | 📅 2025-06-03
...
* [MatCaps](https://github.com/nidorx/matcaps) ⭐ 3,331 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 : Huge library of matcap PNG textures organized by color.
* [Blender-Colab](https://github.com/syn73/blender-colab) ⭐ 229 | 🐛 14 | 🌐 Jupyter Notebook | 📅 2026-08-04 : Render on ***Google Colab***, this is a Python script that allows you to render Blender scene using Google Colaboratory. Only Cycles.
...
* [MeshLab](http://www.meshlab.net/) : Open source system for processing and editing 3D triangular meshes. [![][repo]](https://github.com/cnr-isti-vclab/meshlab) ⭐ 5,792 | 🐛 197 | 🌐 C++ | 📅 2026-08-12
* [AutoRemesher](https://github.com/huxingyi/autoremesher) ⭐ 3,225 | 🐛 33 | 🌐 C++ | 📅 2026-08-16 : Open-source auto-retopology tool intended to convert source meshes into clean, animation-friendly all-quad geometry.
...
* [Natron](https://natrongithub.github.io/) : Open Source Compositing Software For VFX and Motion Graphics. [![][repo]](https://github.com/NatronGitHub/Natron) ⭐ 5,478 | 🐛 281 | 🌐 C++ | 📅 2026-07-24
* [SHADERed](https://github.com/dfranx/SHADERed) ⭐ 4,784 | 🐛 119 | 🌐 C++ | 📅 2023-09-22 : is a lightweight tool for creating and testing HLSL and GLSL shaders.
* [F3D](http://f3d.app) : Fast and minimalist open source cross-platform 3D viewer. Support many fileformats and rendering style. [![][repo]](https://github.com/f3d-app/f3d) ⭐ 4,631 | 🐛 336 | 🌐 C++ | 📅 2026-08-17
* [DJV](https://darbyjohnston.github.io/DJV/) : Professional image sequence, media review software for VFX, animation, and film production. [![][repo]](https://github.com/darbyjohnston/DJV) ⭐ 1,088 | 🐛 129 | 🌐 C++ | 📅 2026-08-16
...
* [JWildfire](http://www.andreas-maschke.com/?page_id=42) : Stands out for its flame fractal generator. Wildfire is a java-based image processing software. [![][repo]](https://github.com/thargor6/JWildfire) ⭐ 253 | 🐛 24 | 🌐 Java | 📅 2026-08-11
...
* [Meshroom](https://alicevision.org/#meshroom) : is a free, open-source 3D Photogrammetry Software. [![][repo]](https://github.com/alicevision/meshroom) ⭐ 12,903 | 🐛 516 | 🌐 Python | 📅 2026-08-14
* [COLMAP](https://colmap.github.io/) : Reconstruct 3D models from ordered or unordered image collections automatically. [![][repo]](https://github.com/colmap/colmap) ⭐ 12,492 | 🐛 704 | 🌐 C++ | 📅 2026-08-14
...
* [Material Maker](https://rodzilla.itch.io/material-maker) : is a simple procedural materials generation tool. [![][repo]](https://github.com/RodZill4/material-maker) ⭐ 5,835 | 🐛 318 | 🌐 GDScript | 📅 2026-08-06
* [ArmorPaint](https://armorpaint.org/) : Open-Source 3D PBR Texture Painting Software. [![][repo]](https://github.com/armory3d/armorpaint) ⭐ 4,026 | 🐛 93 | 🌐 C | 📅 2026-08-14
* [Materialize](http://boundingboxsoftware.com/materialize/) : is a stand alone tool for creating materials from images. [![][repo]](https://github.com/BoundingBoxSoftware/Materialize) ⭐ 1,785 | 🐛 47 | 🌐 C# | 📅 2024-06-24
* [AwesomeBump](https://github.com/kmkolasinski/AwesomeBump) ⭐ 1,770 | 🐛 18 | 🌐 C++ | 📅 2023-01-11 : Generate normal, height, specular or ambient occlusion textures from a single image.
...
* [USGS/Entwine](https://usgs.entwine.io/) : This website provides Potree and Plasio.js interfaces to the AWS USGS LiDAR Public Dataset. [![][repo]](https://github.com/hobu/usgs-lidar) ⭐ 172 | 🐛 31 | 🌐 JavaScript | 📅 2026-08-16
* [Sketchfab/lidar](https://sketchfab.com/tags/lidar), [Sketchfab/point-cloud](https://sketchfab.com/tags/point-cloud).

### Generator [^](#table)

* [city-roads](https://anvaka.github.io/city-roads/) : This website allows you to select a city and then draws every single road on a screen. [![][repo]](https://github.com/anvaka/city-roads) ⭐ 9,548 | 🐛 47 | 🌐 JavaScript | 📅 2026-03-17
...
* [Krita](https://krita.org/en/) : is a professional free and open source painting program. It is made by artists that want to see affordable art tools for everyone. [![][repo]](https://github.com/KDE/krita) ⭐ 10,221 | 🐛 0 | 🌐 C++ | 📅 2026-08-17
...
* Sources:
  ...
  * [fake-bpy-module](https://github.com/nutti/fake-bpy-module) ⭐ 1,803 | 🐛 4 | 🌐 Python | 📅 2026-08-09 : is the collections of the fake Blender Python API modules for the code completion in commonly used IDEs.
  ...
  * [Geometry Script](https://github.com/carson-katri/geometry-script) ⭐ 338 | 🐛 32 | 🌐 Python | 📅 2025-07-07 : is a scripting API for Blender's Geometry Nodes. It makes complicated node trees more managable and easy to share.
* Support:
...
* [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 314,363 | 🐛 16 | 🌐 Python | 📅 2026-08-16 : A curated list of awesome Python frameworks, libraries, software and resources.
* [All Algorithms implemented in Python](https://github.com/TheAlgorithms/Python) ⭐ 223,797 | 🐛 1,039 | 🌐 Python | 📅 2026-08-03.

### Learn Computer Graphics [^](#table)

* [tinyrenderer](https://github.com/ssloy/tinyrenderer/wiki) ⭐ 24,104 | 🐛 4 | 🌐 C++ | 📅 2026-07-29 : Tiny Renderer or how OpenGL works: software rendering in 500 lines of code.
* [tinyraytracer](https://github.com/ssloy/tinyraytracer/wiki) ⭐ 5,356 | 🐛 16 | 🌐 C++ | 📅 2023-07-07 : Understandable RayTracing in 256 lines of bare C++.
...
* [Awesome Design Tools](https://github.com/LisaDziuba/Awesome-Design-Tools) ⭐ 40,902 | 🐛 181 | 🌐 JavaScript | 📅 2024-07-28 : The best design tools and plugins for everything.
* [Awesome Design](https://github.com/gztchan/awesome-design) ⭐ 17,417 | 🐛 56 | 📅 2024-07-04 : Curated design resources.
* [Awesome Stock Resources](https://github.com/neutraltone/awesome-stock-resources) ⭐ 14,431 | 🐛 68 | 🌐 Ruby | 📅 2026-02-11 : A collection of links for free stock photography, video and Illustration websites.
...
* [Awesome Gamedev](https://github.com/Calinou/awesome-gamedev) ⭐ 3,102 | 🐛 13 | 📅 2026-07-07 : A curated list of good stuff related to the development of games.
* [awesome-3d-printing](https://github.com/ad-si/awesome-3d-printing) ⭐ 1,929 | 🐛 15 | 📅 2026-08-11 : A curated list of awesome 3D printing resources.
* [Photogrammetry Guide](https://github.com/mikeroyal/Photogrammetry-Guide) ⭐ 1,514 | 🐛 2 | 🌐 Python | 📅 2025-06-27 : A guide covering Photogrammetry including the applications, libraries and tools that will make you a better and more efficient Photogrammetry development.
...
Your contributions are always welcome! ^\_^ If you want to contribute to this list, send a *pull request*, open an *issue* or *contact with me* @agmmnn. Please read the *[contributing guidelines](https://github.com/agmmnn/awesome-blender/blob/master/CONTRIBUTING.md) ⭐ 7,203 | 🐛 23 | 📅 2026-01-22* first, some sections have their own guidelines as a comment line.
