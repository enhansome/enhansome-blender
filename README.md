...
* [MPFB](http://static.makehumancommunity.org/mpfb.html) : MPFB2 is an open source human generator for Blender. It's complete rewrite of MakeHuman as a Blender addon. [![][repo]](https://github.com/makehumancommunity/mpfb2) ⭐ 586 | 🐛 77 | 🌐 Python | 📅 2026-08-10
...
* Environment:
  * [Infinigen](https://infinigen.org) : Infinigen is a procedural generator of 3D scenes. It can generate infinite Photorealistic Worlds using real geometry. Infinigen is optimized for computer vision research and generates diverse high-quality 3D training data. [![][repo]](https://github.com/princeton-vl/infinigen) ⭐ 7,249 | 🐛 197 | 🌐 Python | 📅 2026-08-27
...
* CAD:
  * [CAD Sketcher](https://www.cadsketcher.com) : CAD Sketcher is a free and open-source project looking to enhance precision workflows in blender by bringing CAD like tools, features and usability. [![][repo]](https://github.com/hlorus/CAD_Sketcher) ⭐ 3,407 | 🐛 14 | 🌐 Python | 📅 2026-09-04 ![][gpl]
  * [BlenderBIM](https://blenderbim.org) : An add-on for beautiful, detailed, and data-rich OpenBIM with Blender. [![][repo]](https://github.com/ifcopenshell/ifcopenshell) ⭐ 2,756 | 🐛 2,000 | 🌐 C++ | 📅 2026-09-04 ![][gpl]
  * [Sverchok](https://nortikin.github.io/sverchok) : is a powerful parametric tool for architects, allowing geometry to be programmed visually with nodes. [![][repo]](https://github.com/nortikin/sverchok) ⭐ 2,517 | 🐛 221 | 🌐 Python | 📅 2026-09-04 ![][gpl]
...
* Retopology/Remesh:
  * [retopoflow](https://blendermarket.com/products/retopoflow) : A suite of retopology tools for Blender. [![][repo]](https://github.com/CGCookie/retopoflow) ⭐ 3,217 | 🐛 89 | 🌐 Python | 📅 2026-09-04
...
* Rigging:
  * [Wiggle Bones](https://blenderartists.org/t/wiggle-2/1454788) : Jiggle bone implementation for Blender with realistic physics. [![][repo]](https://github.com/shteeve3d/blender-wiggle-2) ⭐ 1,018 | 🐛 71 | 🌐 Python | 📅 2024-04-18 ![][gpl]
...
* [Mitsuba Renderer](https://www.mitsuba-renderer.org/) : Mitsuba 3 is a research-oriented retargetable rendering system for forward and inverse light transport simulation. [![][repo]](https://github.com/mitsuba-renderer/mitsuba3) ⭐ 2,909 | 🐛 128 | 🌐 C++ | 📅 2026-09-04 [(blender addon)](https://github.com/mitsuba-renderer/mitsuba-blender) ⭐ 367 | 🐛 34 | 🌐 Python | 📅 2026-07-13
...
* [UcuPaint](https://github.com/ucupumar/ucupaint) ⭐ 2,229 | 🐛 101 | 🌐 Python | 📅 2026-09-04 : A addon to manage texture layers for EEVEE and Cycles renderer.
...
* Game Engine:
  ...
  * [UPBGE](https://upbge.org/) : is an open-source 3D game engine forked from old Blender Game Engine, deployed with Blender itself. [![][repo]](https://github.com/UPBGE/upbge) ⭐ 1,807 | 🐛 134 | 🌐 C++ | 📅 2026-09-05
...
* Geographic/Maps:
  * [BlenderGIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,346 | 🐛 321 | 🌐 Python | 📅 2025-12-20 : Blender addons to make the bridge between Blender and geographic data.
...
* TextEditor:
  * [Snippets Library](https://github.com/Pullusb/snippetsLibrary) ⭐ 39 | 🐛 4 | 🌐 Python | 📅 2026-09-04 : Allow you use and manage a library of your own and existing code snippets.
...
* [NASA-3D-Resources](https://nasa3d.arc.nasa.gov/) : Here you'll find a growing collection of 3D models, textures, and images from inside NASA. All of these resources are free to download and use. [![][repo]](https://github.com/nasa/NASA-3D-Resources) ⭐ 3,767 | 🐛 4 | 📅 2025-06-03
...
* [MatCaps](https://github.com/nidorx/matcaps) ⭐ 3,352 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 : Huge library of matcap PNG textures organized by color.
* [Blender-Colab](https://github.com/syn73/blender-colab) ⭐ 229 | 🐛 15 | 🌐 Jupyter Notebook | 📅 2026-08-04 : Render on ***Google Colab***, this is a Python script that allows you to render Blender scene using Google Colaboratory. Only Cycles.
...
* [Instant Meshes](https://github.com/wjakob/instant-meshes) ⭐ 6,203 | 🐛 97 | 🌐 C++ | 📅 2022-01-03 : Interactive field-aligned mesh generator.
...
* [AutoRemesher](https://github.com/huxingyi/autoremesher) ⭐ 3,429 | 🐛 35 | 🌐 C++ | 📅 2026-09-03 : Open-source auto-retopology tool intended to convert source meshes into clean, animation-friendly all-quad geometry.
...
* [Make Human](http://www.makehumancommunity.org/) : Open-source tool for making 3D characters. ([blender addon](https://github.com/makehumancommunity/makehuman-plugin-for-blender) ⭐ 229 | 🐛 21 | 🌐 Python | 📅 2024-11-23) [![][repo]](https://github.com/makehumancommunity/makehuman) ⭐ 1,559 | 🐛 71 | 🌐 Python | 📅 2024-08-19
...
* [Natron](https://natrongithub.github.io/) : Open Source Compositing Software For VFX and Motion Graphics. [![][repo]](https://github.com/NatronGitHub/Natron) ⭐ 5,507 | 🐛 289 | 🌐 C++ | 📅 2026-07-24
...
* [F3D](http://f3d.app) : Fast and minimalist open source cross-platform 3D viewer. Support many fileformats and rendering style. [![][repo]](https://github.com/f3d-app/f3d) ⭐ 4,667 | 🐛 328 | 🌐 C++ | 📅 2026-09-05
* [DJV](https://darbyjohnston.github.io/DJV/) : Professional image sequence, media review software for VFX, animation, and film production. [![][repo]](https://github.com/darbyjohnston/DJV) ⭐ 1,117 | 🐛 101 | 🌐 C++ | 📅 2026-09-04
...
* [Meshroom](https://alicevision.org/#meshroom) : is a free, open-source 3D Photogrammetry Software. [![][repo]](https://github.com/alicevision/meshroom) ⭐ 12,942 | 🐛 515 | 🌐 Python | 📅 2026-09-05
* [COLMAP](https://colmap.github.io/) : Reconstruct 3D models from ordered or unordered image collections automatically. [![][repo]](https://github.com/colmap/colmap) ⭐ 12,652 | 🐛 708 | 🌐 C++ | 📅 2026-09-05
* [MicMac](https://github.com/micmacIGN/micmac) ⭐ 925 | 🐛 116 | 🌐 C++ | 📅 2026-06-19 : is a free open-source photogrammetric suite that can be used in a variety of 3D reconstruction scenarios.
...
* [Material Maker](https://rodzilla.itch.io/material-maker) : is a simple procedural materials generation tool. [![][repo]](https://github.com/RodZill4/material-maker) ⭐ 5,878 | 🐛 329 | 🌐 GDScript | 📅 2026-08-06
* [ArmorPaint](https://armorpaint.org/) : Open-Source 3D PBR Texture Painting Software. [![][repo]](https://github.com/armory3d/armorpaint) ⭐ 4,051 | 🐛 88 | 🌐 C | 📅 2026-09-04
* [Materialize](http://boundingboxsoftware.com/materialize/) : is a stand alone tool for creating materials from images. [![][repo]](https://github.com/BoundingBoxSoftware/Materialize) ⭐ 1,796 | 🐛 47 | 🌐 C# | 📅 2024-06-24
...
* [USGS/Entwine](https://usgs.entwine.io/) : This website provides Potree and Plasio.js interfaces to the AWS USGS LiDAR Public Dataset. [![][repo]](https://github.com/hobu/usgs-lidar) ⭐ 172 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-04
...
* [city-roads](https://anvaka.github.io/city-roads/) : This website allows you to select a city and then draws every single road on a screen. [![][repo]](https://github.com/anvaka/city-roads) ⭐ 9,596 | 🐛 47 | 🌐 JavaScript | 📅 2026-03-17
* [Procedural City Generator](https://probabletrain.itch.io/city-generator) : Create procedurally generated city maps in the style of American grid-based cities. [![][repo]](https://github.com/ProbableTrain/MapGenerator) ⭐ 1,420 | 🐛 40 | 🌐 TypeScript | 📅 2024-05-09
...
* [Krita](https://krita.org/en/) : is a professional free and open source painting program. It is made by artists that want to see affordable art tools for everyone. [![][repo]](https://github.com/KDE/krita) ⭐ 10,310 | 🐛 0 | 🌐 C++ | 📅 2026-09-05
...
* Sources:
  ...
  * [blender-scripting](https://github.com/njanakiev/blender-scripting) ⭐ 823 | 🐛 2 | 🌐 Python | 📅 2021-09-28 : Introduction to blender scripting. This is a collection of simple to more involved examples to scripting in Blender with Python.
...
* [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 318,341 | 🐛 17 | 🌐 Python | 📅 2026-09-01 : A curated list of awesome Python frameworks, libraries, software and resources.
* [All Algorithms implemented in Python](https://github.com/TheAlgorithms/Python) ⭐ 224,271 | 🐛 897 | 🌐 Python | 📅 2026-09-05.

### Learn Computer Graphics [^](#table)

* [tinyrenderer](https://github.com/ssloy/tinyrenderer/wiki) ⭐ 24,186 | 🐛 4 | 🌐 C++ | 📅 2026-07-29 : Tiny Renderer or how OpenGL works: software rendering in 500 lines of code.
* [tinyraytracer](https://github.com/ssloy/tinyraytracer/wiki) ⭐ 5,362 | 🐛 16 | 🌐 C++ | 📅 2023-07-07 : Understandable RayTracing in 256 lines of bare C++.
...
* [Awesome Design Tools](https://github.com/LisaDziuba/Awesome-Design-Tools) ⭐ 41,090 | 🐛 198 | 🌐 JavaScript | 📅 2024-07-28 : The best design tools and plugins for everything.
* [Awesome Design](https://github.com/gztchan/awesome-design) ⭐ 17,493 | 🐛 61 | 📅 2024-07-04 : Curated design resources.
...
* [Awesome Gamedev](https://github.com/Calinou/awesome-gamedev) ⭐ 3,121 | 🐛 16 | 📅 2026-08-25 : A curated list of good stuff related to the development of games.
...
Your contributions are always welcome! ^\_^ If you want to contribute to this list, send a *pull request*, open an *issue* or *contact with me* @agmmnn. Please read the *[contributing guidelines](https://github.com/agmmnn/awesome-blender/blob/master/CONTRIBUTING.md) ⭐ 7,269 | 🐛 27 | 📅 2026-01-22* first, some sections have their own guidelines as a comment line.
