...
* [Phobos](https://github.com/dfki-ric/phobos) ⭐ 902 | 🐛 14 | 🌐 Python | 📅 2026-07-14 : An add-on for Blender allowing to create URDF, SDF and SMURF robot models.
...
* [MPFB](http://static.makehumancommunity.org/mpfb.html) : MPFB2 is an open source human generator for Blender. It's complete rewrite of MakeHuman as a Blender addon. [![][repo]](https://github.com/makehumancommunity/mpfb2) ⭐ 588 | 🐛 78 | 🌐 Python | 📅 2026-08-10
...
* Environment:
  * [Infinigen](https://infinigen.org) : Infinigen is a procedural generator of 3D scenes. It can generate infinite Photorealistic Worlds using real geometry. Infinigen is optimized for computer vision research and generates diverse high-quality 3D training data. [![][repo]](https://github.com/princeton-vl/infinigen) ⭐ 7,256 | 🐛 197 | 🌐 Python | 📅 2026-08-27
...
* [fspy](https://fspy.io/) : is an open-source camera matching app, extremely useful for modeling directly from a reference image. [(blender addon)](https://github.com/stuffmatic/fSpy-Blender) ⭐ 1,449 | 🐛 59 | 🌐 Python | 📅 2022-05-04
* [BezierUtility](https://github.com/Shriinivas/blenderbezierutils) ⭐ 630 | 🐛 17 | 🌐 Python | 📅 2026-06-17 : This add-on contains several tools for working with Bezier curves.
...
* CAD:
  * [CAD Sketcher](https://www.cadsketcher.com) : CAD Sketcher is a free and open-source project looking to enhance precision workflows in blender by bringing CAD like tools, features and usability. [![][repo]](https://github.com/hlorus/CAD_Sketcher) ⭐ 3,411 | 🐛 16 | 🌐 Python | 📅 2026-09-09 ![][gpl]
  * [BlenderBIM](https://blenderbim.org) : An add-on for beautiful, detailed, and data-rich OpenBIM with Blender. [![][repo]](https://github.com/ifcopenshell/ifcopenshell) ⭐ 2,766 | 🐛 2,005 | 🌐 C++ | 📅 2026-09-09 ![][gpl]
  ...
  * [MeasureIt-ARCH](https://github.com/kevancress/MeasureIt_ARCH) ⭐ 313 | 🐛 85 | 🌐 Python | 📅 2026-03-20 : An expansion of Antonio Vazquez's MeasureIt addon to add features to create Architectural Drawings.
...
* Retopology/Remesh:
  * [retopoflow](https://blendermarket.com/products/retopoflow) : A suite of retopology tools for Blender. [![][repo]](https://github.com/CGCookie/retopoflow) ⭐ 3,223 | 🐛 88 | 🌐 Python | 📅 2026-09-08
...
* [Animation Nodes](https://animation-nodes.com/) : A node based visual scripting system designed for motion graphics in Blender. [![][repo]](https://github.com/JacquesLucke/animation_nodes) ⭐ 2,379 | 🐛 31 | 🌐 Python | 📅 2026-07-07
...
* Rigging:
  ...
  * [Rigid Body Bones](https://github.com/Pauan/blender-rigid-body-bones) ⭐ 156 | 🐛 13 | 🌐 Python | 📅 2023-05-03 : Blender addon which adds rigid body / spring physics to bones.
...
* [DreamWork's MoonRay](https://openmoonray.org/) : MoonRay is a physically based path-tracing renderer; it includes a USD Hydra render delegate, multi-machine and cloud rendering via the Arras distributed computation framework. [![][repo]](https://github.com/dreamworksanimation/openmoonray) ⭐ 4,724 | 🐛 86 | 🌐 CMake | 📅 2026-08-25
* [Mitsuba Renderer](https://www.mitsuba-renderer.org/) : Mitsuba 3 is a research-oriented retargetable rendering system for forward and inverse light transport simulation. [![][repo]](https://github.com/mitsuba-renderer/mitsuba3) ⭐ 2,912 | 🐛 130 | 🌐 C++ | 📅 2026-09-08 [(blender addon)](https://github.com/mitsuba-renderer/mitsuba-blender) ⭐ 367 | 🐛 31 | 🌐 Python | 📅 2026-09-07
...
* [DreamUV](https://github.com/leukbaars/DreamUV) ⭐ 1,792 | 🐛 46 | 🌐 Python | 📅 2026-04-17 : is a collection of tools that allow you to manipulate UVs in the 3D viewport.
...
* [Texel Density Checker](https://gumroad.com/l/CEIOR) : Tools for calculate, set and copy texel density. [![][repo]](https://github.com/mrven/Blender-Texel-Density-Checker) ⭐ 460 | 🐛 5 | 🌐 Python | 📅 2026-07-06
...
* [Blender For Unreal Engine](https://github.com/xavier150/Blender-For-UnrealEngine-Addons) ⭐ 2,656 | 🐛 10 | 🌐 Python | 📅 2026-09-02 : This Add-on allows you to export content created with Blender to Unreal Engine 4.
...
* Game Engine:
  * [Armory3D](https://armory3d.org/) : is an open-source 3D game engine with full Blender integration. [![][repo]](https://github.com/armory3d/armory) ⭐ 3,322 | 🐛 398 | 🌐 C++ | 📅 2026-07-16
...
* Geographic/Maps:
  * [BlenderGIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,363 | 🐛 321 | 🌐 Python | 📅 2025-12-20 : Blender addons to make the bridge between Blender and geographic data.
  * [Maps Models Importer](https://github.com/eliemichel/MapsModelsImporter) ⭐ 2,813 | 🐛 132 | 🌐 Python | 📅 2024-04-21 : A Blender add-on to import models from *Google Maps*. [\[more info\]](https://blog.exppad.com/article/importing-actual-3d-models-from-google-maps)
...
* Import:
  * [Daz Importer](https://bitbucket.org/Diffeomorphic/import-daz/src/master/), [glTF](https://github.com/KhronosGroup/glTF-Blender-IO) ⭐ 1,660 | 🐛 260 | 🌐 Python | 📅 2026-09-09, [Rhinoceros3D files](https://blenderartists.org/t/import-rhinoceros-3d-files-into-blender/1136070), [cityGML](https://github.com/zeffii/io_cityGML_basic) ⭐ 27 | 🐛 2 | 🌐 Python | 📅 2020-08-18, [.SVG](https://github.com/Shriinivas/shapekeyimport) ⭐ 50 | 🐛 0 | 🌐 Python | 📅 2022-12-12, [.XPS](https://github.com/johnzero7/XNALaraMesh) ⭐ 597 | 🐛 38 | 🌐 Python | 📅 2023-11-15, [.GIF](https://github.com/doakey3/Bligify) ⭐ 279 | 🐛 21 | 🌐 Python | 📅 2021-07-30, Quake: [.BSP](https://blenderartists.org/t/quake-1996-game-bsp-import-script/578191) [.MD3](https://github.com/axredneck/blender-md3/tree/blender2.8) ⭐ 11 | 🐛 1 | 🌐 Python | 📅 2020-02-16.
...
* Render:
  ...
  * [Loom](https://github.com/p2or/blender-loom) ⭐ 224 | 🐛 1 | 🌐 Python | 📅 2026-04-29 : Add-on to simplify the rendering process of image sequences and certain frames, allows batch rendering and comes with some handy utilities that help in production.
...
* Camera:
  * [Camera Shakify](https://github.com/EatTheFuture/camera_shakify) ⭐ 1,268 | 🐛 16 | 🌐 Python | 📅 2026-02-07 : An addon for Blender that lets you easily add realistic camera shake to your cameras.
...
* Photogrammetry:
  * [Photogrammetry Importer](https://github.com/SBCV/Blender-Addon-Photogrammetry-Importer) ⭐ 1,363 | 🐛 12 | 🌐 Python | 📅 2026-02-16 : Addon to import different photogrammetry formats into Blender.
...
* [NASA-3D-Resources](https://nasa3d.arc.nasa.gov/) : Here you'll find a growing collection of 3D models, textures, and images from inside NASA. All of these resources are free to download and use. [![][repo]](https://github.com/nasa/NASA-3D-Resources) ⭐ 3,776 | 🐛 4 | 📅 2025-06-03
...
* [MatCaps](https://github.com/nidorx/matcaps) ⭐ 3,357 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 : Huge library of matcap PNG textures organized by color.
...
* [Instant Meshes](https://github.com/wjakob/instant-meshes) ⭐ 6,210 | 🐛 97 | 🌐 C++ | 📅 2022-01-03 : Interactive field-aligned mesh generator.
* [MeshLab](http://www.meshlab.net/) : Open source system for processing and editing 3D triangular meshes. [![][repo]](https://github.com/cnr-isti-vclab/meshlab) ⭐ 5,821 | 🐛 194 | 🌐 C++ | 📅 2026-08-25
* [AutoRemesher](https://github.com/huxingyi/autoremesher) ⭐ 3,441 | 🐛 35 | 🌐 C++ | 📅 2026-09-03 : Open-source auto-retopology tool intended to convert source meshes into clean, animation-friendly all-quad geometry.
* [Goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,187 | 🐛 129 | 🌐 C++ | 📅 2026-07-26 : Create voxel graphics. Export to obj, pyl, png, magica voxel, qubicle.
...
* [Processing](https://processing.org/) : is a flexible software sketchbook and a language for learning how to code within the context of the visual arts. [![][repo]](https://github.com/processing/processing) ⭐ 6,483 | 🐛 0 | 🌐 Java | 📅 2026-07-15
* [Natron](https://natrongithub.github.io/) : Open Source Compositing Software For VFX and Motion Graphics. [![][repo]](https://github.com/NatronGitHub/Natron) ⭐ 5,517 | 🐛 289 | 🌐 C++ | 📅 2026-07-24
...
* [F3D](http://f3d.app) : Fast and minimalist open source cross-platform 3D viewer. Support many fileformats and rendering style. [![][repo]](https://github.com/f3d-app/f3d) ⭐ 4,681 | 🐛 326 | 🌐 C++ | 📅 2026-09-09
* [DJV](https://darbyjohnston.github.io/DJV/) : Professional image sequence, media review software for VFX, animation, and film production. [![][repo]](https://github.com/darbyjohnston/DJV) ⭐ 1,119 | 🐛 102 | 🌐 C++ | 📅 2026-09-09
...
* [Meshroom](https://alicevision.org/#meshroom) : is a free, open-source 3D Photogrammetry Software. [![][repo]](https://github.com/alicevision/meshroom) ⭐ 12,951 | 🐛 517 | 🌐 Python | 📅 2026-09-08
* [COLMAP](https://colmap.github.io/) : Reconstruct 3D models from ordered or unordered image collections automatically. [![][repo]](https://github.com/colmap/colmap) ⭐ 12,673 | 🐛 706 | 🌐 C++ | 📅 2026-09-09
...
* [Dream Textures](https://github.com/carson-katri/dream-textures) ⭐ 8,201 | 🐛 17 | 🌐 Python | 📅 2024-08-26 : Stable Diffusion built-in to the Blender shader editor.
* [Material Maker](https://rodzilla.itch.io/material-maker) : is a simple procedural materials generation tool. [![][repo]](https://github.com/RodZill4/material-maker) ⭐ 5,898 | 🐛 331 | 🌐 GDScript | 📅 2026-08-06
* [ArmorPaint](https://armorpaint.org/) : Open-Source 3D PBR Texture Painting Software. [![][repo]](https://github.com/armory3d/armorpaint) ⭐ 4,179 | 🐛 91 | 🌐 C | 📅 2026-09-04
...
* [USGS/Entwine](https://usgs.entwine.io/) : This website provides Potree and Plasio.js interfaces to the AWS USGS LiDAR Public Dataset. [![][repo]](https://github.com/hobu/usgs-lidar) ⭐ 172 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-08
...
* [city-roads](https://anvaka.github.io/city-roads/) : This website allows you to select a city and then draws every single road on a screen. [![][repo]](https://github.com/anvaka/city-roads) ⭐ 9,624 | 🐛 47 | 🌐 JavaScript | 📅 2026-03-17
...
* [Krita](https://krita.org/en/) : is a professional free and open source painting program. It is made by artists that want to see affordable art tools for everyone. [![][repo]](https://github.com/KDE/krita) ⭐ 10,340 | 🐛 0 | 🌐 C++ | 📅 2026-09-09
...
* Sources:
  * [fake-bpy-module](https://github.com/nutti/fake-bpy-module) ⭐ 1,810 | 🐛 5 | 🌐 Python | 📅 2026-08-09 : is the collections of the fake Blender Python API modules for the code completion in commonly used IDEs.
...
* [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 319,442 | 🐛 19 | 🌐 Python | 📅 2026-09-01 : A curated list of awesome Python frameworks, libraries, software and resources.
* [All Algorithms implemented in Python](https://github.com/TheAlgorithms/Python) ⭐ 224,404 | 🐛 730 | 🌐 Python | 📅 2026-09-09.

### Learn Computer Graphics [^](#table)

* [tinyrenderer](https://github.com/ssloy/tinyrenderer/wiki) ⭐ 24,207 | 🐛 4 | 🌐 C++ | 📅 2026-07-29 : Tiny Renderer or how OpenGL works: software rendering in 500 lines of code.
* [tinyraytracer](https://github.com/ssloy/tinyraytracer/wiki) ⭐ 5,364 | 🐛 16 | 🌐 C++ | 📅 2023-07-07 : Understandable RayTracing in 256 lines of bare C++.
...
* [Awesome Computer Graphics](https://github.com/luisnts/awesome-computer-graphics) ⭐ 1,035 | 🐛 2 | 📅 2021-07-17 : A curated list of awesome stuff to learn computer graphics.

### Related Awesome Lists [^](#table)

* [Awesome Design Tools](https://github.com/LisaDziuba/Awesome-Design-Tools) ⭐ 41,146 | 🐛 198 | 🌐 JavaScript | 📅 2024-07-28 : The best design tools and plugins for everything.
* [Awesome Design](https://github.com/gztchan/awesome-design) ⭐ 17,503 | 🐛 61 | 📅 2024-07-04 : Curated design resources.
...
* [Awesome Gamedev](https://github.com/Calinou/awesome-gamedev) ⭐ 3,128 | 🐛 16 | 📅 2026-08-25 : A curated list of good stuff related to the development of games.
* [awesome-3d-printing](https://github.com/ad-si/awesome-3d-printing) ⭐ 1,957 | 🐛 20 | 📅 2026-08-11 : A curated list of awesome 3D printing resources.
* [Photogrammetry Guide](https://github.com/mikeroyal/Photogrammetry-Guide) ⭐ 1,521 | 🐛 2 | 🌐 Python | 📅 2025-06-27 : A guide covering Photogrammetry including the applications, libraries and tools that will make you a better and more efficient Photogrammetry development.
...
Your contributions are always welcome! ^\_^ If you want to contribute to this list, send a *pull request*, open an *issue* or *contact with me* @agmmnn. Please read the *[contributing guidelines](https://github.com/agmmnn/awesome-blender/blob/master/CONTRIBUTING.md) ⭐ 7,300 | 🐛 27 | 📅 2026-01-22* first, some sections have their own guidelines as a comment line.
