...
* [FLIP Fluids](https://github.com/rlguy/Blender-FLIP-Fluids) ⭐ 1,952 | 🐛 4 | 🌐 C++ | 📅 2026-08-24 : is a powerful liquid simulation plugin that gives you the ability to create high quality fluid effects all within Blender, the free and open source 3D creation suite. [![market]](https://blendermarket.com/products/flipfluids)
* [Phobos](https://github.com/dfki-ric/phobos) ⭐ 905 | 🐛 14 | 🌐 Python | 📅 2026-07-14 : An add-on for Blender allowing to create URDF, SDF and SMURF robot models.
...
* [Sprytile](https://github.com/Sprytile/Sprytile) ⭐ 1,155 | 🐛 67 | 🌐 Python | 📅 2023-10-10 : a blender add-on for building tile based low-poly scenes with paint/map editor like tools. [\[more info\]](https://chemikhazi.itch.io/sprytile)
* [tree-gen](https://github.com/friggog/tree-gen) ⭐ 952 | 🐛 8 | 🌐 Python | 📅 2025-07-11 : procedural generation of tree models in blender.
* [MPFB](http://static.makehumancommunity.org/mpfb.html) : MPFB2 is an open source human generator for Blender. It's complete rewrite of MakeHuman as a Blender addon. [![][repo]](https://github.com/makehumancommunity/mpfb2) ⭐ 605 | 🐛 84 | 🌐 Python | 📅 2026-09-21
...
* Environment:
  * [Infinigen](https://infinigen.org) : Infinigen is a procedural generator of 3D scenes. It can generate infinite Photorealistic Worlds using real geometry. Infinigen is optimized for computer vision research and generates diverse high-quality 3D training data. [![][repo]](https://github.com/princeton-vl/infinigen) ⭐ 7,272 | 🐛 197 | 🌐 Python | 📅 2026-08-27
...
* CAD:
  * [CAD Sketcher](https://www.cadsketcher.com) : CAD Sketcher is a free and open-source project looking to enhance precision workflows in blender by bringing CAD like tools, features and usability. [![][repo]](https://github.com/hlorus/CAD_Sketcher) ⭐ 3,429 | 🐛 16 | 🌐 Python | 📅 2026-09-22 ![][gpl]
  * [BlenderBIM](https://blenderbim.org) : An add-on for beautiful, detailed, and data-rich OpenBIM with Blender. [![][repo]](https://github.com/ifcopenshell/ifcopenshell) ⭐ 2,801 | 🐛 2,016 | 🌐 C++ | 📅 2026-09-22 ![][gpl]
...
* Retopology/Remesh:
  * [retopoflow](https://blendermarket.com/products/retopoflow) : A suite of retopology tools for Blender. [![][repo]](https://github.com/CGCookie/retopoflow) ⭐ 3,251 | 🐛 91 | 🌐 Python | 📅 2026-09-16
...
* Hard Surface:
  ...
  * [ND](https://hugemenace.gumroad.com/l/nd-blender-addon) : is a free non-destructive & interactive hard surface toolkit (smart modifiers, booleans, and geometry management) [![][repo]](https://github.com/hugemenace/nd) ⭐ 131 | 🐛 51 | 🌐 Python | 📅 2026-07-22 [![market]](https://www.blendermarket.com/products/nd-addon)
...
* Mesh Generate/Stylization:
  * [Tissue](https://github.com/alessandro-zomparelli/tissue) ⭐ 1,087 | 🐛 36 | 🌐 Python | 📅 2026-06-07 : Add-on for computational design.
...
* [COA Tools](https://github.com/ndee85/coa_tools) ⭐ 971 | 🐛 117 | 🌐 Python | 📅 2024-05-02 : is a 2D Animation Suite for blender. It offers a 2D cutout animation workflow similar to programs like spine or spriter.
...
* Rigging:
  ...
  * [BlenRig](https://www.blendermarket.com/products/blenrig) : BlenRig is an Auto-rigging and skinning system. It provides the user with a Feature Film quality rig; including an advanced facial system. [![][repo]](https://github.com/jpbouza/BlenRig) ⭐ 171 | 🐛 8 | 🌐 Python | 📅 2026-09-14 ![][gpl]
...
* [Mitsuba Renderer](https://www.mitsuba-renderer.org/) : Mitsuba 3 is a research-oriented retargetable rendering system for forward and inverse light transport simulation. [![][repo]](https://github.com/mitsuba-renderer/mitsuba3) ⭐ 2,929 | 🐛 132 | 🌐 C++ | 📅 2026-09-22 [(blender addon)](https://github.com/mitsuba-renderer/mitsuba-blender) ⭐ 368 | 🐛 31 | 🌐 Python | 📅 2026-09-07
...
* [LuxCore](https://luxcorerender.org/) : LuxCoreRender is a physically based and unbiased rendering engine. It offers advanced features like accelerated rendering of indirect light and efficient rendering of caustics. [![][repo]](https://github.com/LuxCoreRender/LuxCore) ⭐ 1,333 | 🐛 105 | 🌐 C++ | 📅 2026-09-20 [(blender addon)](https://github.com/LuxCoreRender/BlendLuxCore) ⭐ 880 | 🐛 123 | 🌐 Python | 📅 2026-09-20 ![][gpl]
...
* [UcuPaint](https://github.com/ucupumar/ucupaint) ⭐ 2,242 | 🐛 101 | 🌐 Python | 📅 2026-09-22 : A addon to manage texture layers for EEVEE and Cycles renderer.
* [DreamUV](https://github.com/leukbaars/DreamUV) ⭐ 1,797 | 🐛 45 | 🌐 Python | 📅 2026-04-17 : is a collection of tools that allow you to manipulate UVs in the 3D viewport.
...
* [Texel Density Checker](https://gumroad.com/l/CEIOR) : Tools for calculate, set and copy texel density. [![][repo]](https://github.com/mrven/Blender-Texel-Density-Checker) ⭐ 462 | 🐛 6 | 🌐 Python | 📅 2026-07-06
...
* [Blender For Unreal Engine](https://github.com/xavier150/Blender-For-UnrealEngine-Addons) ⭐ 2,673 | 🐛 10 | 🌐 Python | 📅 2026-09-02 : This Add-on allows you to export content created with Blender to Unreal Engine 4.
...
* [Mr Mannequins Tools](https://github.com/Jim-Kroovy/Mr-Mannequins-Tools) ⭐ 550 | 🐛 0 | 🌐 Python | 📅 2026-09-21 : is a Blender add-on that gives the ability to export animations and weighted meshes that are directly compatible with the third person mannequin without re-targeting anything in Unreal Engine!
...
* Game Engine:
  * [Armory3D](https://armory3d.org/) : is an open-source 3D game engine with full Blender integration. [![][repo]](https://github.com/armory3d/armory) ⭐ 3,339 | 🐛 398 | 🌐 C++ | 📅 2026-09-09
  * [UPBGE](https://upbge.org/) : is an open-source 3D game engine forked from old Blender Game Engine, deployed with Blender itself. [![][repo]](https://github.com/UPBGE/upbge) ⭐ 1,814 | 🐛 130 | 🌐 C++ | 📅 2026-09-22
...
* [BlenderProc](https://github.com/DLR-RM/BlenderProc) ⭐ 3,721 | 🐛 118 | 🌐 Python | 📅 2026-01-20 : A procedural Blender pipeline for photorealistic training image generation.
...
* Lighting/HDRI:
  ...
  * [Extra Lights](https://github.com/jlampel/bl_extra_lights) ⭐ 269 | 🐛 12 | 🌐 Python | 📅 2025-11-27 : is a plugin for Blender that adds physically based, photometric lighting presets to the Add menu. [![market]](https://blendermarket.com/products/extra-lights)
...
* Geographic/Maps:
  * [BlenderGIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,404 | 🐛 321 | 🌐 Python | 📅 2025-12-20 : Blender addons to make the bridge between Blender and geographic data.
...
* [NASA-3D-Resources](https://nasa3d.arc.nasa.gov/) : Here you'll find a growing collection of 3D models, textures, and images from inside NASA. All of these resources are free to download and use. [![][repo]](https://github.com/nasa/NASA-3D-Resources) ⭐ 3,797 | 🐛 4 | 📅 2025-06-03
...
* [MatCaps](https://github.com/nidorx/matcaps) ⭐ 3,364 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 : Huge library of matcap PNG textures organized by color.
* [Blender-Colab](https://github.com/syn73/blender-colab) ⭐ 233 | 🐛 15 | 🌐 Jupyter Notebook | 📅 2026-09-16 : Render on ***Google Colab***, this is a Python script that allows you to render Blender scene using Google Colaboratory. Only Cycles.
...
* [MeshLab](http://www.meshlab.net/) : Open source system for processing and editing 3D triangular meshes. [![][repo]](https://github.com/cnr-isti-vclab/meshlab) ⭐ 5,841 | 🐛 194 | 🌐 C++ | 📅 2026-08-25
* [AutoRemesher](https://github.com/huxingyi/autoremesher) ⭐ 3,493 | 🐛 35 | 🌐 C++ | 📅 2026-09-03 : Open-source auto-retopology tool intended to convert source meshes into clean, animation-friendly all-quad geometry.
* [Goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,193 | 🐛 130 | 🌐 C++ | 📅 2026-07-26 : Create voxel graphics. Export to obj, pyl, png, magica voxel, qubicle.
...
* [Natron](https://natrongithub.github.io/) : Open Source Compositing Software For VFX and Motion Graphics. [![][repo]](https://github.com/NatronGitHub/Natron) ⭐ 5,544 | 🐛 289 | 🌐 C++ | 📅 2026-07-24
* [SHADERed](https://github.com/dfranx/SHADERed) ⭐ 4,800 | 🐛 120 | 🌐 C++ | 📅 2023-09-22 : is a lightweight tool for creating and testing HLSL and GLSL shaders.
* [F3D](http://f3d.app) : Fast and minimalist open source cross-platform 3D viewer. Support many fileformats and rendering style. [![][repo]](https://github.com/f3d-app/f3d) ⭐ 4,713 | 🐛 330 | 🌐 C++ | 📅 2026-09-22
* [DJV](https://darbyjohnston.github.io/DJV/) : Professional image sequence, media review software for VFX, animation, and film production. [![][repo]](https://github.com/darbyjohnston/DJV) ⭐ 1,128 | 🐛 68 | 🌐 C++ | 📅 2026-09-22
...
* [Meshroom](https://alicevision.org/#meshroom) : is a free, open-source 3D Photogrammetry Software. [![][repo]](https://github.com/alicevision/meshroom) ⭐ 12,976 | 🐛 520 | 🌐 Python | 📅 2026-09-18
* [COLMAP](https://colmap.github.io/) : Reconstruct 3D models from ordered or unordered image collections automatically. [![][repo]](https://github.com/colmap/colmap) ⭐ 12,787 | 🐛 714 | 🌐 C++ | 📅 2026-09-22
...
* [Dream Textures](https://github.com/carson-katri/dream-textures) ⭐ 8,208 | 🐛 15 | 🌐 Python | 📅 2026-09-17 : Stable Diffusion built-in to the Blender shader editor.
* [Material Maker](https://rodzilla.itch.io/material-maker) : is a simple procedural materials generation tool. [![][repo]](https://github.com/RodZill4/material-maker) ⭐ 5,936 | 🐛 324 | 🌐 GDScript | 📅 2026-09-20
* [ArmorPaint](https://armorpaint.org/) : Open-Source 3D PBR Texture Painting Software. [![][repo]](https://github.com/armory3d/armorpaint) ⭐ 5,163 | 🐛 98 | 🌐 C | 📅 2026-09-18
...
* [USGS/Entwine](https://usgs.entwine.io/) : This website provides Potree and Plasio.js interfaces to the AWS USGS LiDAR Public Dataset. [![][repo]](https://github.com/hobu/usgs-lidar) ⭐ 172 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-21
...
* [city-roads](https://anvaka.github.io/city-roads/) : This website allows you to select a city and then draws every single road on a screen. [![][repo]](https://github.com/anvaka/city-roads) ⭐ 9,667 | 🐛 47 | 🌐 JavaScript | 📅 2026-03-17
* [Procedural City Generator](https://probabletrain.itch.io/city-generator) : Create procedurally generated city maps in the style of American grid-based cities. [![][repo]](https://github.com/ProbableTrain/MapGenerator) ⭐ 1,429 | 🐛 40 | 🌐 TypeScript | 📅 2024-05-09
...
* [Krita](https://krita.org/en/) : is a professional free and open source painting program. It is made by artists that want to see affordable art tools for everyone. [![][repo]](https://github.com/KDE/krita) ⭐ 10,408 | 🐛 0 | 🌐 C++ | 📅 2026-09-22
...
* Sources:
  ...
  * [Blender Development in VS Code](https://marketplace.visualstudio.com/items?itemName=JacquesLucke.blender-development) : Visual Studio Code extension for Blender development. [![][repo]](https://github.com/JacquesLucke/blender_vscode) ⭐ 742 | 🐛 67 | 🌐 TypeScript | 📅 2026-07-10
  ...
  * [blender-addon-tester](https://github.com/nangtani/blender-addon-tester) ⭐ 71 | 🐛 19 | 🌐 Python | 📅 2025-03-20 : The blender addon tester is a test harness to enable pytest hook to allow addons to be tested inside a defined version of blender.
...
* [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 322,232 | 🐛 21 | 🌐 Python | 📅 2026-09-20 : A curated list of awesome Python frameworks, libraries, software and resources.
* [All Algorithms implemented in Python](https://github.com/TheAlgorithms/Python) ⭐ 224,855 | 🐛 176 | 🌐 Python | 📅 2026-09-22.

### Learn Computer Graphics [^](#table)

* [tinyrenderer](https://github.com/ssloy/tinyrenderer/wiki) ⭐ 24,282 | 🐛 4 | 🌐 C++ | 📅 2026-07-29 : Tiny Renderer or how OpenGL works: software rendering in 500 lines of code.
...
* [Awesome Design Tools](https://github.com/LisaDziuba/Awesome-Design-Tools) ⭐ 41,278 | 🐛 208 | 🌐 JavaScript | 📅 2024-07-28 : The best design tools and plugins for everything.
* [Awesome Design](https://github.com/gztchan/awesome-design) ⭐ 17,559 | 🐛 63 | 📅 2024-07-04 : Curated design resources.
* [Awesome Stock Resources](https://github.com/neutraltone/awesome-stock-resources) ⭐ 14,555 | 🐛 88 | 🌐 Ruby | 📅 2026-02-11 : A collection of links for free stock photography, video and Illustration websites.
...
* [Awesome Gamedev](https://github.com/Calinou/awesome-gamedev) ⭐ 3,137 | 🐛 19 | 📅 2026-08-25 : A curated list of good stuff related to the development of games.
* [awesome-3d-printing](https://github.com/ad-si/awesome-3d-printing) ⭐ 1,976 | 🐛 27 | 📅 2026-08-11 : A curated list of awesome 3D printing resources.
...
Your contributions are always welcome! ^\_^ If you want to contribute to this list, send a *pull request*, open an *issue* or *contact with me* @agmmnn. Please read the *[contributing guidelines](https://github.com/agmmnn/awesome-blender/blob/master/CONTRIBUTING.md) ⭐ 7,355 | 🐛 29 | 📅 2026-01-22* first, some sections have their own guidelines as a comment line.
