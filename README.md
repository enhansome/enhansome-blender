...
* [FLIP Fluids](https://github.com/rlguy/Blender-FLIP-Fluids) ⭐ 1,945 | 🐛 4 | 🌐 C++ | 📅 2026-08-24 : is a powerful liquid simulation plugin that gives you the ability to create high quality fluid effects all within Blender, the free and open source 3D creation suite. [![market]](https://blendermarket.com/products/flipfluids)
* [Phobos](https://github.com/dfki-ric/phobos) ⭐ 901 | 🐛 14 | 🌐 Python | 📅 2026-07-14 : An add-on for Blender allowing to create URDF, SDF and SMURF robot models.
...
* [tree-gen](https://github.com/friggog/tree-gen) ⭐ 949 | 🐛 8 | 🌐 Python | 📅 2025-07-11 : procedural generation of tree models in blender.
* [MPFB](http://static.makehumancommunity.org/mpfb.html) : MPFB2 is an open source human generator for Blender. It's complete rewrite of MakeHuman as a Blender addon. [![][repo]](https://github.com/makehumancommunity/mpfb2) ⭐ 587 | 🐛 77 | 🌐 Python | 📅 2026-08-10
...
* Environment:
  * [Infinigen](https://infinigen.org) : Infinigen is a procedural generator of 3D scenes. It can generate infinite Photorealistic Worlds using real geometry. Infinigen is optimized for computer vision research and generates diverse high-quality 3D training data. [![][repo]](https://github.com/princeton-vl/infinigen) ⭐ 7,248 | 🐛 197 | 🌐 Python | 📅 2026-08-27
...
* [BezierUtility](https://github.com/Shriinivas/blenderbezierutils) ⭐ 629 | 🐛 17 | 🌐 Python | 📅 2026-06-17 : This add-on contains several tools for working with Bezier curves.
...
* [Drop It](https://blenderartists.org/t/drop-it-free-addon/1244259/) : Designed to drop fast and simply Objects to Ground or Surface. [![][repo]](https://github.com/maxivz/interactivetoolsblender) ⭐ 185 | 🐛 18 | 🌐 Python | 📅 2026-07-18
...
* CAD:
  * [CAD Sketcher](https://www.cadsketcher.com) : CAD Sketcher is a free and open-source project looking to enhance precision workflows in blender by bringing CAD like tools, features and usability. [![][repo]](https://github.com/hlorus/CAD_Sketcher) ⭐ 3,405 | 🐛 16 | 🌐 Python | 📅 2026-09-03 ![][gpl]
  * [BlenderBIM](https://blenderbim.org) : An add-on for beautiful, detailed, and data-rich OpenBIM with Blender. [![][repo]](https://github.com/ifcopenshell/ifcopenshell) ⭐ 2,751 | 🐛 1,994 | 🌐 C++ | 📅 2026-09-04 ![][gpl]
  * [Sverchok](https://nortikin.github.io/sverchok) : is a powerful parametric tool for architects, allowing geometry to be programmed visually with nodes. [![][repo]](https://github.com/nortikin/sverchok) ⭐ 2,517 | 🐛 221 | 🌐 Python | 📅 2026-08-02 ![][gpl]
...
* Manufacturing/CAM:
  * [BlenderCAM](https://blendercam.com) : An Open Source solution for CAM with Blender 3D. [![][repo]](https://github.com/vilemduha/blendercam) ⭐ 577 | 🐛 24 | 🌐 G-code | 📅 2026-01-01 ![][gpl]
* Retopology/Remesh:
  * [retopoflow](https://blendermarket.com/products/retopoflow) : A suite of retopology tools for Blender. [![][repo]](https://github.com/CGCookie/retopoflow) ⭐ 3,216 | 🐛 88 | 🌐 Python | 📅 2026-09-04
...
* Hard Surface:
  * [EdgeFlow](https://github.com/BenjaminSauder/EdgeFlow/tree/blender_28) ⭐ 1,575 | 🐛 4 | 🌐 Python | 📅 2025-05-11 : This addon adds two operators to blender which both work on edgeloop selections.
...
* Sculpt:
  * [GoB](https://github.com/JoseConseco/GoB) ⭐ 761 | 🐛 77 | 🌐 Python | 📅 2026-08-30 : GoZ-alike tools for simple ZBrush-Blender interchange.
...
* Mesh Generate/Stylization:
  * [Tissue](https://github.com/alessandro-zomparelli/tissue) ⭐ 1,085 | 🐛 36 | 🌐 Python | 📅 2026-06-07 : Add-on for computational design.
...
* [Animation Nodes](https://animation-nodes.com/) : A node based visual scripting system designed for motion graphics in Blender. [![][repo]](https://github.com/JacquesLucke/animation_nodes) ⭐ 2,378 | 🐛 31 | 🌐 Python | 📅 2026-07-07
...
* Rigging:
  * [Wiggle Bones](https://blenderartists.org/t/wiggle-2/1454788) : Jiggle bone implementation for Blender with realistic physics. [![][repo]](https://github.com/shteeve3d/blender-wiggle-2) ⭐ 1,017 | 🐛 71 | 🌐 Python | 📅 2024-04-18 ![][gpl]
...
* [Mitsuba Renderer](https://www.mitsuba-renderer.org/) : Mitsuba 3 is a research-oriented retargetable rendering system for forward and inverse light transport simulation. [![][repo]](https://github.com/mitsuba-renderer/mitsuba3) ⭐ 2,908 | 🐛 128 | 🌐 C++ | 📅 2026-09-03 [(blender addon)](https://github.com/mitsuba-renderer/mitsuba-blender) ⭐ 366 | 🐛 33 | 🌐 Python | 📅 2026-07-13
...
* [LuxCore](https://luxcorerender.org/) : LuxCoreRender is a physically based and unbiased rendering engine. It offers advanced features like accelerated rendering of indirect light and efficient rendering of caustics. [![][repo]](https://github.com/LuxCoreRender/LuxCore) ⭐ 1,325 | 🐛 104 | 🌐 C++ | 📅 2026-08-05 [(blender addon)](https://github.com/LuxCoreRender/BlendLuxCore) ⭐ 875 | 🐛 124 | 🌐 Python | 📅 2026-08-08 ![][gpl]
...
* [TexTools](https://blenderartists.org/t/textools-for-blender/700811) : TexTools is a Free addon for Blender 3D with a set of professional UV and Texturing tools. [![][repo]](https://github.com/SavMartin/TexTools-Blender) ⭐ 2,380 | 🐛 55 | 🌐 Python | 📅 2024-12-02
* [UcuPaint](https://github.com/ucupumar/ucupaint) ⭐ 2,226 | 🐛 101 | 🌐 Python | 📅 2026-09-04 : A addon to manage texture layers for EEVEE and Cycles renderer.
* [DreamUV](https://github.com/leukbaars/DreamUV) ⭐ 1,791 | 🐛 46 | 🌐 Python | 📅 2026-04-17 : is a collection of tools that allow you to manipulate UVs in the 3D viewport.
...
* [Texel Density Checker](https://gumroad.com/l/CEIOR) : Tools for calculate, set and copy texel density. [![][repo]](https://github.com/mrven/Blender-Texel-Density-Checker) ⭐ 459 | 🐛 5 | 🌐 Python | 📅 2026-07-06
...
* [Blender For Unreal Engine](https://github.com/xavier150/Blender-For-UnrealEngine-Addons) ⭐ 2,648 | 🐛 10 | 🌐 Python | 📅 2026-09-02 : This Add-on allows you to export content created with Blender to Unreal Engine 4.
...
* [Mixamo Converter](https://github.com/enziop/mixamo_converter) ⭐ 813 | 🐛 13 | 🌐 Python | 📅 2024-03-01 : is a Blender Plugin that Converts Mixamo animations to work in Unreal Engine 4 with root motion.
...
* Game Engine:
  ...
  * [UPBGE](https://upbge.org/) : is an open-source 3D game engine forked from old Blender Game Engine, deployed with Blender itself. [![][repo]](https://github.com/UPBGE/upbge) ⭐ 1,807 | 🐛 134 | 🌐 C++ | 📅 2026-09-03
...
* [Simple Renaming Panel](https://github.com/Weisl/simple_renaming_panel) ⭐ 200 | 🐛 5 | 🌐 Python | 📅 2026-08-04 : Rename more objects at once. The tool includes basic functionalities of adding suffixes, prefixes, search and replace, add suffixes depending on the object type and much more.
...
* Lighting/HDRI:
  ...
  * [HDRI Sun Aligner](https://github.com/akej74/hdri-sun-aligner) ⭐ 136 | 🐛 6 | 🌐 Python | 📅 2024-03-11 : HDRI Sun Aligner is a Blender addon for automatically rotating an object (e.g. a sun) to match the brightest point in a HDRI environment texture.
...
* Geographic/Maps:
  * [BlenderGIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,344 | 🐛 321 | 🌐 Python | 📅 2025-12-20 : Blender addons to make the bridge between Blender and geographic data.
...
* Import:
  * [Daz Importer](https://bitbucket.org/Diffeomorphic/import-daz/src/master/), [glTF](https://github.com/KhronosGroup/glTF-Blender-IO) ⭐ 1,660 | 🐛 260 | 🌐 Python | 📅 2026-09-03, [Rhinoceros3D files](https://blenderartists.org/t/import-rhinoceros-3d-files-into-blender/1136070), [cityGML](https://github.com/zeffii/io_cityGML_basic) ⭐ 27 | 🐛 2 | 🌐 Python | 📅 2020-08-18, [.SVG](https://github.com/Shriinivas/shapekeyimport) ⭐ 50 | 🐛 0 | 🌐 Python | 📅 2022-12-12, [.XPS](https://github.com/johnzero7/XNALaraMesh) ⭐ 595 | 🐛 38 | 🌐 Python | 📅 2023-11-15, [.GIF](https://github.com/doakey3/Bligify) ⭐ 279 | 🐛 21 | 🌐 Python | 📅 2021-07-30, Quake: [.BSP](https://blenderartists.org/t/quake-1996-game-bsp-import-script/578191) [.MD3](https://github.com/axredneck/blender-md3/tree/blender2.8) ⭐ 11 | 🐛 1 | 🌐 Python | 📅 2020-02-16.
  * [Sketchfab Blender Addon](https://github.com/sketchfab/blender-plugin) ⭐ 1,331 | 🐛 38 | 🌐 Python | 📅 2026-08-06 : Directly import and export models from and to Sketchfab in Blender.
* Export:
  * [USDZ](https://github.com/robmcrosby/BlenderUSDZ) ⭐ 527 | 🐛 55 | 🌐 Python | 📅 2026-08-02, [glTF MultiExport](https://github.com/MozillaReality/blender-gltf-multiexport-addon) ⚠️ Archived, [ZBrush](https://blenderartists.org/t/goz-for-blender-2-8/1138418), [.VTK](https://github.com/tkeskita/io_mesh_vtk) ⭐ 17 | 🐛 1 | 🌐 Python | 📅 2019-10-26, [Bezier2SVG](https://leomoon.com/downloads/plugins/leomoon-bezier2svg/), [Panda3D](https://github.com/Moguri/blend2bam) ⭐ 73 | 🐛 16 | 🌐 Python | 📅 2025-07-20, [.EGG](https://github.com/kergalym/PRPEE), [XRay-engine](https://github.com/PavelBlend/blender-xray) ⭐ 269 | 🐛 22 | 🌐 Python | 📅 2026-06-06.
...
* TextEditor:
  * [Snippets Library](https://github.com/Pullusb/snippetsLibrary) ⭐ 39 | 🐛 4 | 🌐 Python | 📅 2026-09-02 : Allow you use and manage a library of your own and existing code snippets.
...
* [Awesome-3D-Meshes : List of famous 3D meshes.](https://github.com/jvm-graphics-labs/awesome-3d-meshes/) ⭐ 121 | 🐛 0 | 📅 2019-04-25
...
* [Bandai Namco Research Motiondataset](https://github.com/BandaiNamcoResearchInc/Bandai-Namco-Research-Motiondataset) ⭐ 3,331 | 🐛 10 | 🌐 Python | 📅 2023-07-04 : the R\&D division of game publisher and developer Bandai Namco, has released a massive library of free motion-capture data for research and personal use.
...
* [NASA-3D-Resources](https://nasa3d.arc.nasa.gov/) : Here you'll find a growing collection of 3D models, textures, and images from inside NASA. All of these resources are free to download and use. [![][repo]](https://github.com/nasa/NASA-3D-Resources) ⭐ 3,766 | 🐛 4 | 📅 2025-06-03
...
* [MatCaps](https://github.com/nidorx/matcaps) ⭐ 3,351 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 : Huge library of matcap PNG textures organized by color.
...
* [Instant Meshes](https://github.com/wjakob/instant-meshes) ⭐ 6,202 | 🐛 97 | 🌐 C++ | 📅 2022-01-03 : Interactive field-aligned mesh generator.
* [MeshLab](http://www.meshlab.net/) : Open source system for processing and editing 3D triangular meshes. [![][repo]](https://github.com/cnr-isti-vclab/meshlab) ⭐ 5,816 | 🐛 194 | 🌐 C++ | 📅 2026-08-25
* [AutoRemesher](https://github.com/huxingyi/autoremesher) ⭐ 3,427 | 🐛 35 | 🌐 C++ | 📅 2026-09-03 : Open-source auto-retopology tool intended to convert source meshes into clean, animation-friendly all-quad geometry.
* [Goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,186 | 🐛 129 | 🌐 C++ | 📅 2026-07-26 : Create voxel graphics. Export to obj, pyl, png, magica voxel, qubicle.
* [Make Human](http://www.makehumancommunity.org/) : Open-source tool for making 3D characters. ([blender addon](https://github.com/makehumancommunity/makehuman-plugin-for-blender) ⭐ 229 | 🐛 21 | 🌐 Python | 📅 2024-11-23) [![][repo]](https://github.com/makehumancommunity/makehuman) ⭐ 1,557 | 🐛 71 | 🌐 Python | 📅 2024-08-19
...
* [Natron](https://natrongithub.github.io/) : Open Source Compositing Software For VFX and Motion Graphics. [![][repo]](https://github.com/NatronGitHub/Natron) ⭐ 5,507 | 🐛 284 | 🌐 C++ | 📅 2026-07-24
...
* [F3D](http://f3d.app) : Fast and minimalist open source cross-platform 3D viewer. Support many fileformats and rendering style. [![][repo]](https://github.com/f3d-app/f3d) ⭐ 4,666 | 🐛 331 | 🌐 C++ | 📅 2026-09-04
* [DJV](https://darbyjohnston.github.io/DJV/) : Professional image sequence, media review software for VFX, animation, and film production. [![][repo]](https://github.com/darbyjohnston/DJV) ⭐ 1,114 | 🐛 101 | 🌐 C++ | 📅 2026-09-04
...
* [Meshroom](https://alicevision.org/#meshroom) : is a free, open-source 3D Photogrammetry Software. [![][repo]](https://github.com/alicevision/meshroom) ⭐ 12,942 | 🐛 516 | 🌐 Python | 📅 2026-09-03
* [COLMAP](https://colmap.github.io/) : Reconstruct 3D models from ordered or unordered image collections automatically. [![][repo]](https://github.com/colmap/colmap) ⭐ 12,647 | 🐛 707 | 🌐 C++ | 📅 2026-09-04
* [MicMac](https://github.com/micmacIGN/micmac) ⭐ 924 | 🐛 116 | 🌐 C++ | 📅 2026-06-19 : is a free open-source photogrammetric suite that can be used in a variety of 3D reconstruction scenarios.
...
* [Material Maker](https://rodzilla.itch.io/material-maker) : is a simple procedural materials generation tool. [![][repo]](https://github.com/RodZill4/material-maker) ⭐ 5,873 | 🐛 326 | 🌐 GDScript | 📅 2026-08-06
* [ArmorPaint](https://armorpaint.org/) : Open-Source 3D PBR Texture Painting Software. [![][repo]](https://github.com/armory3d/armorpaint) ⭐ 4,045 | 🐛 88 | 🌐 C | 📅 2026-09-04
* [Materialize](http://boundingboxsoftware.com/materialize/) : is a stand alone tool for creating materials from images. [![][repo]](https://github.com/BoundingBoxSoftware/Materialize) ⭐ 1,795 | 🐛 47 | 🌐 C# | 📅 2024-06-24
* [AwesomeBump](https://github.com/kmkolasinski/AwesomeBump) ⭐ 1,772 | 🐛 18 | 🌐 C++ | 📅 2023-01-11 : Generate normal, height, specular or ambient occlusion textures from a single image.
...
* [USGS/Entwine](https://usgs.entwine.io/) : This website provides Potree and Plasio.js interfaces to the AWS USGS LiDAR Public Dataset. [![][repo]](https://github.com/hobu/usgs-lidar) ⭐ 172 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-03
...
* [city-roads](https://anvaka.github.io/city-roads/) : This website allows you to select a city and then draws every single road on a screen. [![][repo]](https://github.com/anvaka/city-roads) ⭐ 9,595 | 🐛 47 | 🌐 JavaScript | 📅 2026-03-17
* [Procedural City Generator](https://probabletrain.itch.io/city-generator) : Create procedurally generated city maps in the style of American grid-based cities. [![][repo]](https://github.com/ProbableTrain/MapGenerator) ⭐ 1,419 | 🐛 40 | 🌐 TypeScript | 📅 2024-05-09
...
* [Krita](https://krita.org/en/) : is a professional free and open source painting program. It is made by artists that want to see affordable art tools for everyone. [![][repo]](https://github.com/KDE/krita) ⭐ 10,305 | 🐛 0 | 🌐 C++ | 📅 2026-09-04
...
* Sources:
  ...
  * [Blender Development in VS Code](https://marketplace.visualstudio.com/items?itemName=JacquesLucke.blender-development) : Visual Studio Code extension for Blender development. [![][repo]](https://github.com/JacquesLucke/blender_vscode) ⭐ 738 | 🐛 67 | 🌐 TypeScript | 📅 2026-07-10
...
* [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 318,134 | 🐛 16 | 🌐 Python | 📅 2026-09-01 : A curated list of awesome Python frameworks, libraries, software and resources.
* [All Algorithms implemented in Python](https://github.com/TheAlgorithms/Python) ⭐ 224,238 | 🐛 913 | 🌐 Python | 📅 2026-09-04.

### Learn Computer Graphics [^](#table)

* [tinyrenderer](https://github.com/ssloy/tinyrenderer/wiki) ⭐ 24,179 | 🐛 4 | 🌐 C++ | 📅 2026-07-29 : Tiny Renderer or how OpenGL works: software rendering in 500 lines of code.
* [tinyraytracer](https://github.com/ssloy/tinyraytracer/wiki) ⭐ 5,360 | 🐛 16 | 🌐 C++ | 📅 2023-07-07 : Understandable RayTracing in 256 lines of bare C++.
* [Computer Graphics from scratch](https://gabrielgambetta.com/computer-graphics-from-scratch/introduction.html) This book will not teach you how to use OpenGL or DirectX; instead, it can teach you how OpenGL and DirectX work. [![][repo]](https://github.com/ggambetta/computer-graphics-from-scratch) ⭐ 1,312 | 🐛 3 | 📅 2025-09-13
...
* [Awesome Computer Graphics](https://github.com/luisnts/awesome-computer-graphics) ⭐ 1,034 | 🐛 2 | 📅 2021-07-17 : A curated list of awesome stuff to learn computer graphics.

### Related Awesome Lists [^](#table)

* [Awesome Design Tools](https://github.com/LisaDziuba/Awesome-Design-Tools) ⭐ 41,080 | 🐛 197 | 🌐 JavaScript | 📅 2024-07-28 : The best design tools and plugins for everything.
* [Awesome Design](https://github.com/gztchan/awesome-design) ⭐ 17,489 | 🐛 61 | 📅 2024-07-04 : Curated design resources.
* [Awesome Stock Resources](https://github.com/neutraltone/awesome-stock-resources) ⭐ 14,511 | 🐛 72 | 🌐 Ruby | 📅 2026-02-11 : A collection of links for free stock photography, video and Illustration websites.
...
* [Awesome Gamedev](https://github.com/Calinou/awesome-gamedev) ⭐ 3,122 | 🐛 16 | 📅 2026-08-25 : A curated list of good stuff related to the development of games.
* [awesome-3d-printing](https://github.com/ad-si/awesome-3d-printing) ⭐ 1,951 | 🐛 20 | 📅 2026-08-11 : A curated list of awesome 3D printing resources.
* [Photogrammetry Guide](https://github.com/mikeroyal/Photogrammetry-Guide) ⭐ 1,517 | 🐛 2 | 🌐 Python | 📅 2025-06-27 : A guide covering Photogrammetry including the applications, libraries and tools that will make you a better and more efficient Photogrammetry development.
...
Your contributions are always welcome! ^\_^ If you want to contribute to this list, send a *pull request*, open an *issue* or *contact with me* @agmmnn. Please read the *[contributing guidelines](https://github.com/agmmnn/awesome-blender/blob/master/CONTRIBUTING.md) ⭐ 7,268 | 🐛 27 | 📅 2026-01-22* first, some sections have their own guidelines as a comment line.
