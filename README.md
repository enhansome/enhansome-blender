...
* [Sprytile](https://github.com/Sprytile/Sprytile) ⭐ 1,152 | 🐛 66 | 🌐 Python | 📅 2023-10-10 : a blender add-on for building tile based low-poly scenes with paint/map editor like tools. [\[more info\]](https://chemikhazi.itch.io/sprytile)
...
* Environment:
  * [Infinigen](https://infinigen.org) : Infinigen is a procedural generator of 3D scenes. It can generate infinite Photorealistic Worlds using real geometry. Infinigen is optimized for computer vision research and generates diverse high-quality 3D training data. [![][repo]](https://github.com/princeton-vl/infinigen) ⭐ 7,253 | 🐛 197 | 🌐 Python | 📅 2026-08-27
...
* [fspy](https://fspy.io/) : is an open-source camera matching app, extremely useful for modeling directly from a reference image. [(blender addon)](https://github.com/stuffmatic/fSpy-Blender) ⭐ 1,448 | 🐛 59 | 🌐 Python | 📅 2022-05-04
...
* CAD:
  * [CAD Sketcher](https://www.cadsketcher.com) : CAD Sketcher is a free and open-source project looking to enhance precision workflows in blender by bringing CAD like tools, features and usability. [![][repo]](https://github.com/hlorus/CAD_Sketcher) ⭐ 3,408 | 🐛 15 | 🌐 Python | 📅 2026-09-07 ![][gpl]
  * [BlenderBIM](https://blenderbim.org) : An add-on for beautiful, detailed, and data-rich OpenBIM with Blender. [![][repo]](https://github.com/ifcopenshell/ifcopenshell) ⭐ 2,762 | 🐛 2,000 | 🌐 C++ | 📅 2026-09-06 ![][gpl]
...
* Retopology/Remesh:
  * [retopoflow](https://blendermarket.com/products/retopoflow) : A suite of retopology tools for Blender. [![][repo]](https://github.com/CGCookie/retopoflow) ⭐ 3,219 | 🐛 89 | 🌐 Python | 📅 2026-09-05
...
* Sculpt:
  * [GoB](https://github.com/JoseConseco/GoB) ⭐ 762 | 🐛 77 | 🌐 Python | 📅 2026-08-30 : GoZ-alike tools for simple ZBrush-Blender interchange.
...
* Snapping-Align:
  * [Mesh Align Plus](https://github.com/egtwobits/mesh_mesh_align_plus) ⭐ 645 | 🐛 12 | 🌐 Python | 📅 2024-08-10 : Precisely align, move, and measure+match objects and mesh parts in your 3D scenes.
...
* Mesh Generate/Stylization:
  ...
  * [BY-GEN](https://gumroad.com/l/BY-GEN) : is an addon designed to simplify the process of creating non-destructive, generative modeling styles in Blender. [![][repo]](https://github.com/curtisjamesholt/BY-GEN-public) ⭐ 249 | 🐛 0 | 🌐 Python | 📅 2026-05-12
...
* Rigging:
  * [Wiggle Bones](https://blenderartists.org/t/wiggle-2/1454788) : Jiggle bone implementation for Blender with realistic physics. [![][repo]](https://github.com/shteeve3d/blender-wiggle-2) ⭐ 1,019 | 🐛 71 | 🌐 Python | 📅 2024-04-18 ![][gpl]
...
* [Mitsuba Renderer](https://www.mitsuba-renderer.org/) : Mitsuba 3 is a research-oriented retargetable rendering system for forward and inverse light transport simulation. [![][repo]](https://github.com/mitsuba-renderer/mitsuba3) ⭐ 2,912 | 🐛 127 | 🌐 C++ | 📅 2026-09-07 [(blender addon)](https://github.com/mitsuba-renderer/mitsuba-blender) ⭐ 367 | 🐛 31 | 🌐 Python | 📅 2026-09-07
...
* [LuxCore](https://luxcorerender.org/) : LuxCoreRender is a physically based and unbiased rendering engine. It offers advanced features like accelerated rendering of indirect light and efficient rendering of caustics. [![][repo]](https://github.com/LuxCoreRender/LuxCore) ⭐ 1,325 | 🐛 104 | 🌐 C++ | 📅 2026-09-07 [(blender addon)](https://github.com/LuxCoreRender/BlendLuxCore) ⭐ 874 | 🐛 124 | 🌐 Python | 📅 2026-09-06 ![][gpl]
* [Malt](https://malt3d.com/) : Malt is a non photorealistic rendering (NPR) framework. It offers fully customizable real-time rendering framework for animation and illustration. [![][repo]](https://github.com/bnpr/Malt) ⭐ 1,130 | 🐛 27 | 🌐 Python | 📅 2026-03-29 ![][mit]
...
* [TexTools](https://blenderartists.org/t/textools-for-blender/700811) : TexTools is a Free addon for Blender 3D with a set of professional UV and Texturing tools. [![][repo]](https://github.com/SavMartin/TexTools-Blender) ⭐ 2,383 | 🐛 55 | 🌐 Python | 📅 2024-12-02
* [UcuPaint](https://github.com/ucupumar/ucupaint) ⭐ 2,231 | 🐛 101 | 🌐 Python | 📅 2026-09-06 : A addon to manage texture layers for EEVEE and Cycles renderer.
...
* [Blender For Unreal Engine](https://github.com/xavier150/Blender-For-UnrealEngine-Addons) ⭐ 2,654 | 🐛 10 | 🌐 Python | 📅 2026-09-02 : This Add-on allows you to export content created with Blender to Unreal Engine 4.
...
* Game Engine:
  * [Armory3D](https://armory3d.org/) : is an open-source 3D game engine with full Blender integration. [![][repo]](https://github.com/armory3d/armory) ⭐ 3,318 | 🐛 398 | 🌐 C++ | 📅 2026-07-16
  * [UPBGE](https://upbge.org/) : is an open-source 3D game engine forked from old Blender Game Engine, deployed with Blender itself. [![][repo]](https://github.com/UPBGE/upbge) ⭐ 1,808 | 🐛 134 | 🌐 C++ | 📅 2026-09-07
...
* Management:
  * [Shot Manager by Ubisoft](https://github.com/ubisoft/shotmanager) ⭐ 216 | 🐛 10 | 🌐 Python | 📅 2023-08-23 : is a add-on that introduces a true shot entity in Blender scenes.
...
* Geographic/Maps:
  * [BlenderGIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,353 | 🐛 321 | 🌐 Python | 📅 2025-12-20 : Blender addons to make the bridge between Blender and geographic data.
...
* Import:
  * [Daz Importer](https://bitbucket.org/Diffeomorphic/import-daz/src/master/), [glTF](https://github.com/KhronosGroup/glTF-Blender-IO) ⭐ 1,660 | 🐛 262 | 🌐 Python | 📅 2026-09-06, [Rhinoceros3D files](https://blenderartists.org/t/import-rhinoceros-3d-files-into-blender/1136070), [cityGML](https://github.com/zeffii/io_cityGML_basic) ⭐ 27 | 🐛 2 | 🌐 Python | 📅 2020-08-18, [.SVG](https://github.com/Shriinivas/shapekeyimport) ⭐ 50 | 🐛 0 | 🌐 Python | 📅 2022-12-12, [.XPS](https://github.com/johnzero7/XNALaraMesh) ⭐ 596 | 🐛 38 | 🌐 Python | 📅 2023-11-15, [.GIF](https://github.com/doakey3/Bligify) ⭐ 279 | 🐛 21 | 🌐 Python | 📅 2021-07-30, Quake: [.BSP](https://blenderartists.org/t/quake-1996-game-bsp-import-script/578191) [.MD3](https://github.com/axredneck/blender-md3/tree/blender2.8) ⭐ 11 | 🐛 1 | 🌐 Python | 📅 2020-02-16.
...
* VideoEditor:
  ...
  * [VSEQF](https://github.com/snuq/VSEQF) ⭐ 199 | 🐛 2 | 🌐 Python | 📅 2026-03-20 : is an overhaul for Blender's VSE that can completely change your workflow. Designed for quick, mouse and keyboard balanced editing with a focus on real-time feedback.
...
* [NASA-3D-Resources](https://nasa3d.arc.nasa.gov/) : Here you'll find a growing collection of 3D models, textures, and images from inside NASA. All of these resources are free to download and use. [![][repo]](https://github.com/nasa/NASA-3D-Resources) ⭐ 3,771 | 🐛 4 | 📅 2025-06-03
...
* [MatCaps](https://github.com/nidorx/matcaps) ⭐ 3,355 | 🐛 3 | 🌐 JavaScript | 📅 2025-10-13 : Huge library of matcap PNG textures organized by color.
* [Blender-Colab](https://github.com/syn73/blender-colab) ⭐ 230 | 🐛 15 | 🌐 Jupyter Notebook | 📅 2026-08-04 : Render on ***Google Colab***, this is a Python script that allows you to render Blender scene using Google Colaboratory. Only Cycles.
...
* [MeshLab](http://www.meshlab.net/) : Open source system for processing and editing 3D triangular meshes. [![][repo]](https://github.com/cnr-isti-vclab/meshlab) ⭐ 5,819 | 🐛 194 | 🌐 C++ | 📅 2026-08-25
* [AutoRemesher](https://github.com/huxingyi/autoremesher) ⭐ 3,436 | 🐛 35 | 🌐 C++ | 📅 2026-09-03 : Open-source auto-retopology tool intended to convert source meshes into clean, animation-friendly all-quad geometry.
...
* [Make Human](http://www.makehumancommunity.org/) : Open-source tool for making 3D characters. ([blender addon](https://github.com/makehumancommunity/makehuman-plugin-for-blender) ⭐ 229 | 🐛 21 | 🌐 Python | 📅 2024-11-23) [![][repo]](https://github.com/makehumancommunity/makehuman) ⭐ 1,560 | 🐛 71 | 🌐 Python | 📅 2024-08-19
...
* [Natron](https://natrongithub.github.io/) : Open Source Compositing Software For VFX and Motion Graphics. [![][repo]](https://github.com/NatronGitHub/Natron) ⭐ 5,511 | 🐛 289 | 🌐 C++ | 📅 2026-07-24
...
* [F3D](http://f3d.app) : Fast and minimalist open source cross-platform 3D viewer. Support many fileformats and rendering style. [![][repo]](https://github.com/f3d-app/f3d) ⭐ 4,673 | 🐛 327 | 🌐 C++ | 📅 2026-09-05
* [DJV](https://darbyjohnston.github.io/DJV/) : Professional image sequence, media review software for VFX, animation, and film production. [![][repo]](https://github.com/darbyjohnston/DJV) ⭐ 1,119 | 🐛 101 | 🌐 C++ | 📅 2026-09-06
...
* [Meshroom](https://alicevision.org/#meshroom) : is a free, open-source 3D Photogrammetry Software. [![][repo]](https://github.com/alicevision/meshroom) ⭐ 12,947 | 🐛 515 | 🌐 Python | 📅 2026-09-05
* [COLMAP](https://colmap.github.io/) : Reconstruct 3D models from ordered or unordered image collections automatically. [![][repo]](https://github.com/colmap/colmap) ⭐ 12,663 | 🐛 708 | 🌐 C++ | 📅 2026-09-07
...
* [Material Maker](https://rodzilla.itch.io/material-maker) : is a simple procedural materials generation tool. [![][repo]](https://github.com/RodZill4/material-maker) ⭐ 5,885 | 🐛 330 | 🌐 GDScript | 📅 2026-08-06
* [ArmorPaint](https://armorpaint.org/) : Open-Source 3D PBR Texture Painting Software. [![][repo]](https://github.com/armory3d/armorpaint) ⭐ 4,057 | 🐛 89 | 🌐 C | 📅 2026-09-04
...
* [USGS/Entwine](https://usgs.entwine.io/) : This website provides Potree and Plasio.js interfaces to the AWS USGS LiDAR Public Dataset. [![][repo]](https://github.com/hobu/usgs-lidar) ⭐ 172 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-06
...
* [Procedural City Generator](https://probabletrain.itch.io/city-generator) : Create procedurally generated city maps in the style of American grid-based cities. [![][repo]](https://github.com/ProbableTrain/MapGenerator) ⭐ 1,423 | 🐛 40 | 🌐 TypeScript | 📅 2024-05-09
...
* [Krita](https://krita.org/en/) : is a professional free and open source painting program. It is made by artists that want to see affordable art tools for everyone. [![][repo]](https://github.com/KDE/krita) ⭐ 10,324 | 🐛 0 | 🌐 C++ | 📅 2026-09-07
...
* Sources:
  * [fake-bpy-module](https://github.com/nutti/fake-bpy-module) ⭐ 1,809 | 🐛 5 | 🌐 Python | 📅 2026-08-09 : is the collections of the fake Blender Python API modules for the code completion in commonly used IDEs.
  * [blender-cli-rendering](https://github.com/yuki-koyama/blender-cli-rendering) ⭐ 825 | 🐛 7 | 🌐 Python | 📅 2023-11-29 : Python scripts for rendering images using Blender from command-line interface.
...
* [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 318,960 | 🐛 19 | 🌐 Python | 📅 2026-09-01 : A curated list of awesome Python frameworks, libraries, software and resources.
* [All Algorithms implemented in Python](https://github.com/TheAlgorithms/Python) ⭐ 224,337 | 🐛 774 | 🌐 Python | 📅 2026-09-07.

### Learn Computer Graphics [^](#table)

* [tinyrenderer](https://github.com/ssloy/tinyrenderer/wiki) ⭐ 24,197 | 🐛 4 | 🌐 C++ | 📅 2026-07-29 : Tiny Renderer or how OpenGL works: software rendering in 500 lines of code.
...
* [Awesome Design Tools](https://github.com/LisaDziuba/Awesome-Design-Tools) ⭐ 41,123 | 🐛 200 | 🌐 JavaScript | 📅 2024-07-28 : The best design tools and plugins for everything.
* [Awesome Design](https://github.com/gztchan/awesome-design) ⭐ 17,500 | 🐛 61 | 📅 2024-07-04 : Curated design resources.
...
* [GameDev Resources](https://github.com/Kavex/GameDev-Resources) ⭐ 6,902 | 🐛 14 | 📅 2026-04-10 : A wonderful list of Game Development resources.
* [Awesome Gamedev](https://github.com/Calinou/awesome-gamedev) ⭐ 3,124 | 🐛 16 | 📅 2026-08-25 : A curated list of good stuff related to the development of games.
* [awesome-3d-printing](https://github.com/ad-si/awesome-3d-printing) ⭐ 1,954 | 🐛 20 | 📅 2026-08-11 : A curated list of awesome 3D printing resources.
...
Your contributions are always welcome! ^\_^ If you want to contribute to this list, send a *pull request*, open an *issue* or *contact with me* @agmmnn. Please read the *[contributing guidelines](https://github.com/agmmnn/awesome-blender/blob/master/CONTRIBUTING.md) ⭐ 7,291 | 🐛 27 | 📅 2026-01-22* first, some sections have their own guidelines as a comment line.
