...
* [FLIP Fluids](https://github.com/rlguy/Blender-FLIP-Fluids) ⭐ 1,948 | 🐛 4 | 🌐 C++ | 📅 2026-08-24 : is a powerful liquid simulation plugin that gives you the ability to create high quality fluid effects all within Blender, the free and open source 3D creation suite. [![market]](https://blendermarket.com/products/flipfluids)
* [Phobos](https://github.com/dfki-ric/phobos) ⭐ 903 | 🐛 14 | 🌐 Python | 📅 2026-07-14 : An add-on for Blender allowing to create URDF, SDF and SMURF robot models.
...
* Environment:
  * [Infinigen](https://infinigen.org) : Infinigen is a procedural generator of 3D scenes. It can generate infinite Photorealistic Worlds using real geometry. Infinigen is optimized for computer vision research and generates diverse high-quality 3D training data. [![][repo]](https://github.com/princeton-vl/infinigen) ⭐ 7,261 | 🐛 197 | 🌐 Python | 📅 2026-08-27
...
* [BezierUtility](https://github.com/Shriinivas/blenderbezierutils) ⭐ 630 | 🐛 18 | 🌐 Python | 📅 2026-06-17 : This add-on contains several tools for working with Bezier curves.
...
* CAD:
  * [CAD Sketcher](https://www.cadsketcher.com) : CAD Sketcher is a free and open-source project looking to enhance precision workflows in blender by bringing CAD like tools, features and usability. [![][repo]](https://github.com/hlorus/CAD_Sketcher) ⭐ 3,414 | 🐛 15 | 🌐 Python | 📅 2026-09-10 ![][gpl]
  * [BlenderBIM](https://blenderbim.org) : An add-on for beautiful, detailed, and data-rich OpenBIM with Blender. [![][repo]](https://github.com/ifcopenshell/ifcopenshell) ⭐ 2,777 | 🐛 2,007 | 🌐 C++ | 📅 2026-09-11 ![][gpl]
...
* Retopology/Remesh:
  * [retopoflow](https://blendermarket.com/products/retopoflow) : A suite of retopology tools for Blender. [![][repo]](https://github.com/CGCookie/retopoflow) ⭐ 3,228 | 🐛 89 | 🌐 Python | 📅 2026-09-10
...
* Hard Surface:
  * [EdgeFlow](https://github.com/BenjaminSauder/EdgeFlow/tree/blender_28) ⭐ 1,576 | 🐛 4 | 🌐 Python | 📅 2025-05-11 : This addon adds two operators to blender which both work on edgeloop selections.
...
* Sculpt:
  * [GoB](https://github.com/JoseConseco/GoB) ⭐ 763 | 🐛 74 | 🌐 Python | 📅 2026-09-09 : GoZ-alike tools for simple ZBrush-Blender interchange.
...
* Snapping-Align:
  * [Mesh Align Plus](https://github.com/egtwobits/mesh_mesh_align_plus) ⭐ 647 | 🐛 12 | 🌐 Python | 📅 2024-08-10 : Precisely align, move, and measure+match objects and mesh parts in your 3D scenes.
...
* Rigging:
  * [Wiggle Bones](https://blenderartists.org/t/wiggle-2/1454788) : Jiggle bone implementation for Blender with realistic physics. [![][repo]](https://github.com/shteeve3d/blender-wiggle-2) ⭐ 1,021 | 🐛 71 | 🌐 Python | 📅 2024-04-18 ![][gpl]
...
* [Mitsuba Renderer](https://www.mitsuba-renderer.org/) : Mitsuba 3 is a research-oriented retargetable rendering system for forward and inverse light transport simulation. [![][repo]](https://github.com/mitsuba-renderer/mitsuba3) ⭐ 2,914 | 🐛 133 | 🌐 C++ | 📅 2026-09-11 [(blender addon)](https://github.com/mitsuba-renderer/mitsuba-blender) ⭐ 368 | 🐛 31 | 🌐 Python | 📅 2026-09-07
...
* [DreamUV](https://github.com/leukbaars/DreamUV) ⭐ 1,793 | 🐛 45 | 🌐 Python | 📅 2026-04-17 : is a collection of tools that allow you to manipulate UVs in the 3D viewport.
...
* [Blender For Unreal Engine](https://github.com/xavier150/Blender-For-UnrealEngine-Addons) ⭐ 2,659 | 🐛 10 | 🌐 Python | 📅 2026-09-02 : This Add-on allows you to export content created with Blender to Unreal Engine 4.
...
* [Mixamo Converter](https://github.com/enziop/mixamo_converter) ⭐ 814 | 🐛 13 | 🌐 Python | 📅 2024-03-01 : is a Blender Plugin that Converts Mixamo animations to work in Unreal Engine 4 with root motion.
...
* Game Engine:
  * [Armory3D](https://armory3d.org/) : is an open-source 3D game engine with full Blender integration. [![][repo]](https://github.com/armory3d/armory) ⭐ 3,328 | 🐛 397 | 🌐 C++ | 📅 2026-09-09
  * [UPBGE](https://upbge.org/) : is an open-source 3D game engine forked from old Blender Game Engine, deployed with Blender itself. [![][repo]](https://github.com/UPBGE/upbge) ⭐ 1,811 | 🐛 134 | 🌐 C++ | 📅 2026-09-11
...
* Geographic/Maps:
  * [BlenderGIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,370 | 🐛 321 | 🌐 Python | 📅 2025-12-20 : Blender addons to make the bridge between Blender and geographic data.
  * [Maps Models Importer](https://github.com/eliemichel/MapsModelsImporter) ⭐ 2,816 | 🐛 132 | 🌐 Python | 📅 2024-04-21 : A Blender add-on to import models from *Google Maps*. [\[more info\]](https://blog.exppad.com/article/importing-actual-3d-models-from-google-maps)
...
* Render:
  ...
  * [Loom](https://github.com/p2or/blender-loom) ⭐ 225 | 🐛 1 | 🌐 Python | 📅 2026-04-29 : Add-on to simplify the rendering process of image sequences and certain frames, allows batch rendering and comes with some handy utilities that help in production.
...
* [NASA-3D-Resources](https://nasa3d.arc.nasa.gov/) : Here you'll find a growing collection of 3D models, textures, and images from inside NASA. All of these resources are free to download and use. [![][repo]](https://github.com/nasa/NASA-3D-Resources) ⭐ 3,780 | 🐛 4 | 📅 2025-06-03
...
* [Instant Meshes](https://github.com/wjakob/instant-meshes) ⭐ 6,212 | 🐛 97 | 🌐 C++ | 📅 2022-01-03 : Interactive field-aligned mesh generator.
* [MeshLab](http://www.meshlab.net/) : Open source system for processing and editing 3D triangular meshes. [![][repo]](https://github.com/cnr-isti-vclab/meshlab) ⭐ 5,824 | 🐛 194 | 🌐 C++ | 📅 2026-08-25
* [AutoRemesher](https://github.com/huxingyi/autoremesher) ⭐ 3,449 | 🐛 35 | 🌐 C++ | 📅 2026-09-03 : Open-source auto-retopology tool intended to convert source meshes into clean, animation-friendly all-quad geometry.
...
* [Make Human](http://www.makehumancommunity.org/) : Open-source tool for making 3D characters. ([blender addon](https://github.com/makehumancommunity/makehuman-plugin-for-blender) ⭐ 229 | 🐛 21 | 🌐 Python | 📅 2024-11-23) [![][repo]](https://github.com/makehumancommunity/makehuman) ⭐ 1,564 | 🐛 71 | 🌐 Python | 📅 2024-08-19
...
* [SHADERed](https://github.com/dfranx/SHADERed) ⭐ 4,792 | 🐛 120 | 🌐 C++ | 📅 2023-09-22 : is a lightweight tool for creating and testing HLSL and GLSL shaders.
* [F3D](http://f3d.app) : Fast and minimalist open source cross-platform 3D viewer. Support many fileformats and rendering style. [![][repo]](https://github.com/f3d-app/f3d) ⭐ 4,687 | 🐛 325 | 🌐 C++ | 📅 2026-09-10
* [DJV](https://darbyjohnston.github.io/DJV/) : Professional image sequence, media review software for VFX, animation, and film production. [![][repo]](https://github.com/darbyjohnston/DJV) ⭐ 1,120 | 🐛 86 | 🌐 C++ | 📅 2026-09-11
...
* [Meshroom](https://alicevision.org/#meshroom) : is a free, open-source 3D Photogrammetry Software. [![][repo]](https://github.com/alicevision/meshroom) ⭐ 12,953 | 🐛 518 | 🌐 Python | 📅 2026-09-09
* [COLMAP](https://colmap.github.io/) : Reconstruct 3D models from ordered or unordered image collections automatically. [![][repo]](https://github.com/colmap/colmap) ⭐ 12,687 | 🐛 711 | 🌐 C++ | 📅 2026-09-11
...
* [Dream Textures](https://github.com/carson-katri/dream-textures) ⭐ 8,202 | 🐛 17 | 🌐 Python | 📅 2024-08-26 : Stable Diffusion built-in to the Blender shader editor.
* [Material Maker](https://rodzilla.itch.io/material-maker) : is a simple procedural materials generation tool. [![][repo]](https://github.com/RodZill4/material-maker) ⭐ 5,907 | 🐛 333 | 🌐 GDScript | 📅 2026-08-06
* [ArmorPaint](https://armorpaint.org/) : Open-Source 3D PBR Texture Painting Software. [![][repo]](https://github.com/armory3d/armorpaint) ⭐ 4,553 | 🐛 101 | 🌐 C | 📅 2026-09-11
...
* [AwesomeBump](https://github.com/kmkolasinski/AwesomeBump) ⭐ 1,773 | 🐛 18 | 🌐 C++ | 📅 2023-01-11 : Generate normal, height, specular or ambient occlusion textures from a single image.
...
* [USGS/Entwine](https://usgs.entwine.io/) : This website provides Potree and Plasio.js interfaces to the AWS USGS LiDAR Public Dataset. [![][repo]](https://github.com/hobu/usgs-lidar) ⭐ 172 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-10
...
* [city-roads](https://anvaka.github.io/city-roads/) : This website allows you to select a city and then draws every single road on a screen. [![][repo]](https://github.com/anvaka/city-roads) ⭐ 9,639 | 🐛 47 | 🌐 JavaScript | 📅 2026-03-17
...
* [Krita](https://krita.org/en/) : is a professional free and open source painting program. It is made by artists that want to see affordable art tools for everyone. [![][repo]](https://github.com/KDE/krita) ⭐ 10,347 | 🐛 0 | 🌐 C++ | 📅 2026-09-11
...
* [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 319,891 | 🐛 20 | 🌐 Python | 📅 2026-09-01 : A curated list of awesome Python frameworks, libraries, software and resources.
* [All Algorithms implemented in Python](https://github.com/TheAlgorithms/Python) ⭐ 224,470 | 🐛 573 | 🌐 Python | 📅 2026-09-11.

### Learn Computer Graphics [^](#table)

* [tinyrenderer](https://github.com/ssloy/tinyrenderer/wiki) ⭐ 24,218 | 🐛 4 | 🌐 C++ | 📅 2026-07-29 : Tiny Renderer or how OpenGL works: software rendering in 500 lines of code.
...
* [Awesome Design Tools](https://github.com/LisaDziuba/Awesome-Design-Tools) ⭐ 41,173 | 🐛 203 | 🌐 JavaScript | 📅 2024-07-28 : The best design tools and plugins for everything.
* [Awesome Design](https://github.com/gztchan/awesome-design) ⭐ 17,510 | 🐛 62 | 📅 2024-07-04 : Curated design resources.
...
* [awesome-3d-printing](https://github.com/ad-si/awesome-3d-printing) ⭐ 1,962 | 🐛 20 | 📅 2026-08-11 : A curated list of awesome 3D printing resources.
...
Your contributions are always welcome! ^\_^ If you want to contribute to this list, send a *pull request*, open an *issue* or *contact with me* @agmmnn. Please read the *[contributing guidelines](https://github.com/agmmnn/awesome-blender/blob/master/CONTRIBUTING.md) ⭐ 7,309 | 🐛 28 | 📅 2026-01-22* first, some sections have their own guidelines as a comment line.
